...
import { D as T } from "./dice-roll-g2p52PvP.js";
...
const Pt = (t) => (A("data-v-36829786"), (t = t()), w(), t),
  ...
  Qt = G(() => i("h4", null, "TO HIT", -1)),
  Jt = G(() => i("div", { class: "divider" }, null, -1)),
  Yt = { class: "damage-container" },
  Kt = G(() => i("h4", { class: "padding-left" }, " DAMAGE ", -1)),
  Xt = "#5cb85c",
  Zt = "#d9534f",
  te = "#fff",
  ee = D({
  ...
  Q = (t) => (A("data-v-8c49b71f"), (t = t()), w(), t),
  ne = { class: "campaign-log-content" },
  oe = { class: "header" },
  ie = Q(() => i("div", { class: "title" }, " Results ", -1)),
  ae = Q(() =>
  ...
  pe = D({
    ...
    setup(t) {
      M((f) => ({ ee9c0238: a.value, "1a2aa262": r.value }));
      const { height: e } = bt(),
        n = t,
        o = V(null),
        s = (f) => {
  ...
  qn = C(pe, [["__scopeId", "data-v-8c49b71f"]]),
  ...
  Jn = (t) => t.split("=")[0].split(":")[1],
  Yn = (t) => t.split("=")[0].split(":")[0],
  Kn = (t, e) => {
    let n;
  ...
  oo = (t, e) => {
    ...
    t.inventory[n].itemType === "misc" ||
      ...
      t.inventory[n].equipped ? Je(t, n) : ct(t, n));
  },
  io = (t, e, n) => {
    t[n] = P(e, 3);
  },
  ...
  as = mt(() => i("img", { src: Ye, alt: "concluir" }, null, -1)),
  ls = [as],
  rs = D({
