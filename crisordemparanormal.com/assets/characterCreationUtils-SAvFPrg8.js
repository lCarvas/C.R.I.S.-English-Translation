import { S as o, s as u, c as d } from "./characterAutomations-VjVSWhq1.js";
...
const a = {
  ...
  P = (e, i) => {
    if (i !== null) {
      if (
        ((e.backgroundName = i.name),
        (i.power.id = t()),
        e.powers.push(i.power),
        i.power.hasAutomation)
      ) {
        const s = d.find((n) => n.id === i.power.automationId);
        if (!(s != null && s.onAdd)) return;
        s.onAdd(e);
      }
...
export { p as a, v as b, a as c, P as d, x as u };
