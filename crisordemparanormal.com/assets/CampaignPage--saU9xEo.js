...
import { L as fa } from "./LoadingView-_iqLshHh.js";
import { C as Xa } from "./CharacterCard-GD5PfX5I.js";
import { T as Ya } from "./ToastNotification-4wp0r3IV.js";
import { P as ae } from "./PictureModal-KjvpKroR.js";
import { T as ee } from "./TabNav-bhLeyoEJ.js";
import { P as te } from "./PlayerCard-UqxAK4j6.js";
import { C as oe } from "./CombatCard-CYDp1I5J.js";
import { g as se } from "./firebase-7sah6mo2.js";
...
const ie = "/assets/vtt-campaing-page-button-3COS2uxr.svg",
  le =
  ...
  Mt = ba({
    ...
    setup(y) {
      const v = Ga(),
        ...
        d = qa(),
        ia = Ja().params.id,
        Q = "https://crisordemparanormal.com/",
        I = l(!0),
        j = l(!1),
        P = l(!1),
        R = l(!1),
      ...
      za(async () => {
        ...
        const g = J(r, "characters"),
          b = z(g, L("campaignDocId", "==", t.value.id));
        W.value = ma(b, (aa) => {
          const F = [];
          ...
          (x.value = F), T.value < 2 && T.value++;
        });
        const C = J(r, "users"),
          Z = z(C, L("campaignsId", "array-contains", t.value.id));
        X.value = ma(Z, (aa) => {
          var O;
          const F = [];
          for (const q of aa.docs) {
            const ea = q.data();
            ea.tier >= 4 && (Y.value = !0),
              ea.uid !== ((O = t.value) == null ? void 0 : O.uid) && F.push(ea);
          }
          (A.value = F), T.value < 2 && T.value++;
        });
      }),
        Ka(() => {
          W.value && W.value(), X.value && X.value();
        }),
        va(T, () => {
          I.value !== !1 && T.value >= 2 && (I.value = !1);
        });
      const Va = () => {
          t.value &&
            _.value &&
        ...
        da = async () => {
          t.value &&
            (await navigator.clipboard.writeText(
              Q + "campanha/entrar/" + t.value.joinId
            ),
      ...
      const Ia = () => {
        ...
        Ua = async () => {
          var a, c;
          if (!((a = H.value) != null && a.id)) return;
          S.value = !0;
          const o = (c = H.value) == null ? void 0 : c.id;
        ...
        Sa = async () => {
          ...
          const o = J(r, "characters"),
            a = z(
              o,
              L("campaignDocId", "==", t.value.id),
              L("uid", "==", (g = U.value) == null ? void 0 : g.uid)
            ),
            c = await ga(a);
        ...
        Ta = async () => {
          ...
          const o = J(r, "characters"),
            a = z(
              o,
              L("campaignDocId", "==", t.value.id),
              L("uid", "==", (g = v.currentUser) == null ? void 0 : g.uid)
            ),
            c = await ga(a);
          for (const b of c.docs) {
            const C = b.data();
        ...
        xa = (o) => {
          const a = x.value.findIndex((c) => c.id === o);
          (H.value = x.value[a]), (j.value = !0);
        },
        Aa = (o) => {
          const a = A.value.findIndex((c) => (c.uid = o));
          (U.value = A.value[a]), (B.value = !0);
        },
        w = () => {
          (B.value = !1),
            (P.value = !1),
        ...
        ja = () => {
          ...
          Y.value ? window.open(o.href, "_blank") : (G.value = !0);
        };
      return (o, a) => {
        var g, b, C, Z, E;
        const c = Qa("vue-final-modal");
        return I.value
                  ...
                  : (n(),
                    i(
                      "button",
                      {
                        ...
                        onClick: a[0] || (a[0] = (s) => (D.value = !D.value)),
                      },
                      " Leave Campaign "
                    )),
                _.value
                                        ...
                                        i("div", { key: s.id }, [
                                          h(
                                            Xa,
                                            {
                                              ...
                                              onHandleOpenSheetMidClick: Ha,
                                              onHandleOpenSheet: (M) =>
                                                o.$router.push({
                                                  name: "character-sheet",
                                                  params: { id: s.id },
                                                }),
                                              onHandleRemoveFromCampaign: xa,
                                            },
                                            null,
                                            8,
                                            [
                          ...
                          e("div", { class: "modal-content modal-width" }, [
                            ...
                            e("div", { class: "modal-body" }, [
                              ...
                              e("div", { class: "button-container" }, [
                                e(
                                  "button",
                                  { class: "button-primary", onClick: Sa },
                                  " Confirm "
                                ),
                              ]),
                            ]),
