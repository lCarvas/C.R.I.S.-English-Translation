...
const P =
  ...
  te = u(() => t("img", { class: "icon", src: P, alt: "deletar" }, null, -1)),
  ae = u(() => t("img", { class: "icon", src: M, alt: "deletar" }, null, -1)),
  re = D({
    __name: "CreatureCard",
    props: {
    ...
    setup(r, { emit: v }) {
      ...
      const e = r,
        ...
        h = b(null);
      R(h, (n) => {
        (n.target && n.target.id === "img.settings-button") || (o.value = !1);
      });
      const _ = () => {
        ...
        p = () => {
          (o.value = !1), l("handleEdit", e.creature);
        },
        w = () => {
          e.creature.id && ((o.value = !1), l("handleDelete", e.creature.id));
        },
        k = () => {
          if (e.isDefault) {
            const n = m.resolve({
          ...
          [
            t("div", Z, [
              ...
              t("div", F, [
                ...
                t("div", G, [
                  t("div", J, d(r.creature.name), 1),
                  t("div", W, " VD: " + d(r.creature.vd), 1),
                  t(
                    "div",
                    X,
                    d(r.creature.creatureType) +
                      " - " +
                      d(r.creature.creatureSize),
                    1
                  ),
                ]),
                t("div", Y, [
  ...
  le = T(re, [["__scopeId", "data-v-2fb0ad73"]]);
export { le as C };
