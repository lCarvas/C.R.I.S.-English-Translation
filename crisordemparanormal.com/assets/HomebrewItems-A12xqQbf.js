...
import { P as Mt, _ as Ge } from "./PowerCard--892reTT.js";
import { S as ke } from "./SearchInput-n9LbYIZb.js";
import { L as pe } from "./LoadingView-H3Q1po81.js";
import { H as de, g as Ee, b as st } from "./firebase-lVLc_m94.js";
import {
  p as Fe,
  r as Oe,
  w as ze,
...
import {
  ...
  e as yt,
  f as wt,
} from "./forms-elmqtkmr.js";
import { S as Pt } from "./SwitchButtonBool-W8E6bK9H.js";
import { _ as x } from "./lodash-gzw5KmHd.js";
import { P as Le } from "./PictureModal-tmAlMhGN.js";
import { T as it } from "./ToastNotification-E6g073Ap.js";
import { R as Et } from "./RitualCard-mXSyskD5.js";
import { T as Ke } from "./TabNav-GB7V06r-.js";
import { D as X } from "./DropdownSimple-gEKaWzqJ.js";
import {
  W as Lt,
  P as qt,
  M as Ut,
...
const xt = (t) => (be("data-v-8b772633"), (t = t()), _e(), t),
              ...
              e("div", Ot, [
                e(
                  "button",
                  {
                    ...
                    onClick: d[0] || (d[0] = (p) => a.$emit("handleConfirm")),
                  },
                  " Confirmar "
                ),
                e(
                  "button",
                  {
                    ...
                    onClick: d[1] || (d[1] = (p) => a.$emit("handleCancel")),
                  },
                  " Cancel "
                ),
              ]),
  ...
  oa = F({
    ...
    setup(t, { emit: a }) {
      ...
      const d = t,
        ...
        E = y(!0),
        H = y(0),
        k = (m) => p("handleAddPower", m),
        V = (m) => p("handleEditPower", m);
      Je(async () => {
        var He, Me, ye, we, $e;
        ...
        const m = Y(l, "homebrewRituals"),
          ...
          L = await ee(M);
        (C.value =
          R.docs.length + L.docs.length + O.docs.length + ie.docs.length),
          C.value >= de && (E.value = !1);
        const Ie = [];
        for (const Ce of L.docs) {
          const Ae = Ce.data();
          (Ae.id = Ce.id), Ie.push(Ae);
        }
        (u.value = Ie),
          (H.value = await Ee(($e = h.currentUser) == null ? void 0 : $e.uid)),
          (s.value = !1);
      });
      const g = U(() => (d.homebrewList ? "0" : "0.5rem")),
        ...
        w = () => {
          (i.value = ""), (v.value = !1), ($.value = void 0);
        },
        A = () => {
          Ze(Pe(l, "homebrewPowers", i.value)),
            ...
            ($.value = void 0),
            C.value--,
            C.value < de ? (E.value = !0) : (E.value = !1);
        };
      return (m, q) =>
        s.value
          ? (o(), n("div", aa, [c(pe)]))
  ...
  Aa = F({
    ...
    setup(t, { emit: a }) {
      ...
      const d = t,
        ...
        v = () => {
          (h.value = x.clone(Fe)), p("handleClose");
        },
        i = () => {
          s.value ||
            (ft(h.value),
            p("handleCreatePower", h.value),
            (h.value = x.clone(Fe)));
        },
        $ = () => {
          if (s.value) return;
          ...
          p("handleEditPower", H), (h.value = x.clone(Fe));
        },
        C = ["OFF", "ON"],
        E = (H, k) => {
          s.value ||
    ...
    setup(t, { emit: a }) {
      const d = a,
        ...
        u = async (v) => {
          ...
          if (
            ((l.value = !0),
            (await Ee(($ = p.currentUser) == null ? void 0 : $.uid)) < 4 &&
              !(await st(p.currentUser.uid)))
          ) {
            (l.value = !1),
          ...
          (v.uid = p.currentUser.uid),
            await ot(Y(h, "homebrewPowers"), v),
            (l.value = !1),
            d("handleClose");
        };
      et(
            ...
            n("div", ka, [
              c(
                $t,
                {
                  ...
                  onHandleClose: i[0] || (i[0] = ($) => v.$emit("handleClose")),
                },
                null,
                8,
                ["homebrew-list"]
            ...
            n("div", Ha, [
              c(
                $t,
                {
                  ...
                  onHandleEditPower: s,
                  onHandleClose: r[0] || (r[0] = (v) => u.$emit("handleClose")),
                },
                null,
                8,
                ["power", "homebrew-list"]
            ...
            ? (o(),
              n("div", La, [
                c(
                  ...
                  {
                    "homebrew-list": t.homebrewList,
                    onHandleClose: v[1] || (v[1] = (i) => (h.value = l.list)),
                  },
                  null,
                  8,
                  ["homebrew-list"]
  ...
  Ja = F({
    ...
    setup(t, { emit: a }) {
      ...
      const d = t,
        ...
        g = y(!0),
        b = y(0),
        f = (P) => p("handleAddRitual", P),
        w = (P) => p("handleEditRitual", P);
      Je(async () => {
        var $e, Ce, Ae, Re, xe;
        ...
        (v.value = we),
          (b.value = await Ee((xe = s.currentUser) == null ? void 0 : xe.uid)),
          (r.value = !1);
      });
      const A = U(() => (d.homebrewList ? "0" : "0.5rem")),
        ...
        q = (P) => {
          (H.value = P),
            (E.value = !0),
            (k.value = v.value.findIndex((R) => R.id === H.value));
        },
        O = () => {
          (H.value = ""), (E.value = !1), (k.value = void 0);
        },
        I = () => {
          Ze(Pe(u, "homebrewRituals", H.value)),
            v.value.splice(k.value, 1),
            (H.value = ""),
            (E.value = !1),
            (k.value = void 0),
            V.value--,
  ...
  Po = { class: "row" },
  Eo = j(() => e("div", { class: "label" }, " Image ", -1)),
  Lo = { key: 0 },
  qo = ["src"],
  Uo = { key: 1 },
  Ro = j(() =>
  ...
  jo = F({
    ...
    setup(t, { emit: a }) {
      ...
      const d = t,
        ...
        s = ["Standard", "Movement", "Complete", "Reaction", "Free"],
        u = [
          "Personal",
          "Touch",
          "Short",
        ...
        C = () => {
          (r.value = x.clone(Oe)), p("handleClose");
        },
        E = () => {
          i.value ||
            (bt(r.value),
            p("handleCreateRitual", r.value),
            (r.value = x.clone(Oe)));
        },
        H = () => {
          if (i.value) return;
          ...
          p("handleEditRitual", V), (r.value = x.clone(Oe));
        },
        k = (V, g) => {
          i.value ||
    ...
    setup(t, { emit: a }) {
      const d = a,
        ...
        u = async (v) => {
          ...
          (v.uid = p.currentUser.uid),
            await ot(Y(h, "homebrewRituals"), v),
            (l.value = !1),
            d("handleClose");
        };
      et(
  ...
  ns = F({
    ...
    setup(t, { emit: a }) {
      ...
      const d = t,
        ...
        m = y(!0),
        q = y(0),
        O = (T) => p("handleAddItem", T),
        I = (T) => p("handleEditItem", T);
      Je(async () => {
        var ut, ct, mt, pt, vt;
        if (!h.currentUser) return;
        const T = Y(l, "homebrewPowers"),
          ...
          Ae = J(
            Ce,
            Z("uid", "==", (pt = h.currentUser) == null ? void 0 : pt.uid)
          ),
          Re = await ee(Ae);
        (A.value =
          Re.docs.length + L.docs.length + Me.docs.length + $e.docs.length),
        ...
        (u.value = xe),
          ...
          (i.value = rt),
          ($.value = dt),
          (q.value = await Ee((vt = h.currentUser) == null ? void 0 : vt.uid)),
          (s.value = !1);
      });
      const P = U(() => (d.homebrewList ? "0" : "0.5rem")),
        ...
        z = (T) => {
          (b.value = T.id),
            ...
            T.itemType === "protection" &&
              (f.value = v.value.findIndex((M) => M.id === T.id)),
            T.itemType === "misc" &&
        ...
        ie = () => {
          Ze(Pe(l, "homebrewItems", b.value)),
            ...
            w.value === "protection" && v.value.splice(f.value, 1),
                          ...
                          n("div", un, [
                            e(
                              "button",
                              {
                                ...
                                onClick:
                                  M[0] ||
                                  (M[0] = (L) => T.$emit("handleCreateWeapon")),
                              },
                              " Add Weapon ",
                              8,
                              cn
                          ...
                          n(
                            ...
                            ue(
                              ...
                              (L) => (
                                ...
                                n(
                                  "div",
                                  { key: L.id, class: "class-abilitie-card" },
                                  [
                                    L.itemType === "weapon"
                                      ? (o(),
                                        n("div", Pn, [
              ...
              (p) => (
                ...
                n(
                  "button",
                  {
                    ...
                    onClick: (h) => a.$emit("handleNavigation", p.value),
                  },
                  B(p.label),
                  11,
                  ls
  ...
  hs = [
    ...
    },
    {
      name: "Potência",
      description:
        "<p>Este acessório aumenta a DT contra suas habilidades, poderes e rituais em +1.</p>",
      element: "Energia",
      itemType: "misc",
      hasAutomation: !1,
      modType: "curse",
  ...
  bs = F({
    ...
    setup(t) {
      ne((l) => ({ "15a4c800": p.value, "7cac154d": h.value }));
      const a = t,
        d = {
          knowledge: "#ff8c00",
          energy: "#7000AC",
        ...
        p = U(() => d[a.mod.element.toLowerCase()]),
        h = U(() => (p.value === "#fff" ? "#121212" : "#fff"));
      return (l, s) => (
  ...
  Bs = F({
    ...
    setup(t, { emit: a }) {
      const d = t,
        ...
        r = U(() =>
          d.modType === "weapon" ? ps : d.modType === "protection" ? vs : hs
        ),
        v = (i) => {
          p("handleAddMod", i), p("handleCloseModal");
        };
      return (i, $) => (
        o(),
        n("div", gs, [
  ...
  Ve = [
    ...
    },
    {
      ...
      onRemove(t) {
        ...
        const d = a.aditionalDamage.findIndex((p) => p.value === "2");
    ...
    },
    {
      ...
      onRemove(t) {
        const a = t;
        if (!a.aditionalDamage) return;
        const d = a.aditionalDamage.findIndex((p) => p.value === "2d6");
        d !== -1 && a.aditionalDamage.splice(d, 1);
      },
    },
    {
  ...
  pi = Q(() => e("div", { class: "label" }, " Space* ", -1)),
  vi = { class: "title-container" },
  ...
  xi = F({
    ...
    setup(t, { emit: a }) {
      ...
      const d = t,
        ...
        k = () => {
          (i.value = x.clone(ze)), p("handleClose");
        },
        V = () => {
          E.value ||
            (_t(i.value),
            p("handleCreateWeapon", i.value),
            (i.value = x.clone(ze)));
        },
        g = () => {
          if (E.value) return;
          ...
          p("handleEditWeapon", A), (i.value = x.clone(ze));
        },
        b = (A, m) => {
          E.value ||
  ...
  ve = (t) => (be("data-v-e807ed7e"), (t = t()), _e(), t),
  Di = { class: "form-container" },
  Si = { class: "input-container" },
  Bi = ve(() => e("div", { class: "label" }, " Name* ", -1)),
  Fi = { class: "input-row" },
  Oi = { class: "input-container" },
  zi = ve(() => e("div", { class: "label" }, " Defense* ", -1)),
  Ni = { class: "input-container" },
  ji = ve(() => e("div", { class: "label" }, " Category* ", -1)),
  Qi = { class: "input-container" },
  Wi = ve(() => e("div", { class: "label" }, " Space* ", -1)),
  Xi = { class: "title-container" },
  Yi = ve(() => e("div", { class: "title" }, " Upgrades ", -1)),
  ...
  al = ["onClick"],
  ol = ve(() => e("div", { class: "label" }, " Image ", -1)),
  nl = { key: 0 },
  sl = ["src"],
  il = { key: 1 },
  ll = ve(() =>
  ...
  bl = F({
    ...
    setup(t, { emit: a }) {
      ne((g) => ({ "37d40d30": r.value, "3ebfdbf0": v.value }));
      const d = t,
        p = a,
        h = ["0", "I", "II", "III", "IV"],
        ...
        $ = () => {
          (l.value = x.clone(Ne)), p("handleClose");
        },
        C = () => {
          i.value ||
            (gt(l.value),
            p("handleCreateProtection", l.value),
            (l.value = x.clone(Ne)));
        },
        E = () => {
          if (i.value) return;
          ...
          p("handleEditProtection", g), (l.value = x.clone(Ne));
        },
        H = (g, b) => {
          i.value ||
  ...
  Pl = { class: "row" },
  El = { class: "mod-title" },
  Ll = { key: 0, class: "automation-icon", src: Ge, alt: "automação" },
  ql = ["innerHTML"],
  Ul = { class: "button-container" },
  Rl = ["onClick"],
  xl = he(() => e("div", { class: "label" }, " Imagem ", -1)),
  Dl = { key: 0 },
  Sl = ["src"],
  Bl = { key: 1 },
  Fl = he(() =>
  ...
  Kl = F({
    ...
    setup(t, { emit: a }) {
      ne((b) => ({ "707a2d43": v.value, "3ee22375": i.value }));
      const d = t,
        p = a,
        h = ["0", "I", "II", "III", "IV"],
        l = [
        ...
        C = () => {
          (s.value = x.clone(je)), p("handleClose");
        },
        E = () => {
          $.value ||
            (yt(s.value),
            p("handleCreateMisc", s.value),
            (s.value = x.clone(je)));
        },
        H = () => {
          if ($.value) return;
          ...
          p("handleEditMisc", b), (s.value = x.clone(je));
        },
        k = (b, f) => {
          $.value ||
  ...
  Cr = F({
    ...
    setup(t, { emit: a }) {
      ne((k) => ({ "59ebe937": r.value, f8b033fe: v.value }));
      const d = t,
        p = a,
        h = ["0", "I", "II", "III", "IV"],
        ...
        $ = () => {
          (s.value = x.clone(Qe)), p("handleClose");
        },
        C = () => {
          i.value ||
            (wt(s.value),
            p("handleCreateCursedItem", s.value),
            (s.value = x.clone(Qe)));
        },
        E = () => {
          if (i.value) return;
          ...
          p("handleEditCursedItem", k), (s.value = x.clone(Qe));
        },
        H = (k, V) => {
          i.value ||
    ...
    setup(t, { emit: a }) {
      const d = a,
        ...
        r = async (i) => {
          ...
          if (
            ((l.value = !0),
            (await Ee((C = p.currentUser) == null ? void 0 : C.uid)) < 4 &&
              !(await st(p.currentUser.uid)))
          ) {
            (l.value = !1),
  ...
  jr = F({
    ...
    setup(t, { emit: a }) {
      const d = a,
        ...
        i = (E) => d("handleAddItem", E),
        $ = (E) => {
          (h.value = E), (l.value = s.edit);
        },
        C = (E) => {
          (u.value = E), (l.value = s.create);
        };
      return (E, H) => (
        o(),
        n("div", Br, [
                ...
                [
                  c(
                    Ke,
                    {
                      "current-tab": p.value,
                      "tab-options": v,
                      onHandleNavigation: H[0] || (H[0] = (k) => (p.value = k)),
                    },
                    null,
                    8,
                    ["current-tab"]
