...
const Ju = (t) =>
    Ve(t)
      ...
      : t == null
      ? ""
      : J(t) || (Me(t) && (t.toString === Xm || !le(t.toString)))
      ? JSON.stringify(t, eg, 2)
      : String(t),
  eg = (t, e) =>
    e && e.__v_isRef
      ? eg(t, e.value)
...
function sg(t, e) {
  let n = !1;
  is <= Wc ? rg(t) || ((t.n |= lr), (n = !ng(t))) : (n = !t.has(Kt)),
...
class ag {
  ...
  get(e, n, r) {
    ...
    if (n === "__v_raw" && r === (i ? (s ? Sb : hg) : s ? ug : cg).get(e))
      return e;
    const o = J(e);
    if (!i) {
    ...
    return (Qa(n) ? og.has(n) : hb(n)) || (i || qt(e, "get", n), s)
      ? a
      : rt(a)
      ? o && Xu(n)
        ? a
...
class lg extends ag {
  ...
  has(e, n) {
    ...
    return (!Qa(n) || !og.has(n)) && qt(e, "has", n), r;
  }
  ownKeys(e) {
...
function On(t) {
  return Ti(t) ? t : rh(t, !1, mb, Tb, cg);
}
function Qc(t) {
  return rh(t, !1, vb, Ib, ug);
}
function dg(t) {
  return rh(t, !0, gb, Ab, hg);
}
...
const Cs = (t) => (Me(t) ? On(t) : t),
  ih = (t) => (Me(t) ? dg(t) : t);
function mg(t) {
  rr && Kt && ((t = we(t)), sg(t.dep || (t.dep = Zu())));
}
function gg(t, e) {
  t = we(t);
  const n = t.dep;
...
class xb {
  ...
  get value() {
    return mg(this), this._value;
  }
  set value(e) {
    const n = this.__v_isShallow || fa(e) || Ti(e);
    (e = n ? e : we(e)),
      Ur(e, this._rawValue) &&
        ((this._rawValue = e), (this._value = n ? e : Cs(e)), gg(this));
  }
}
function Ye(t) {
  ...
  constructor(e, n, r, i) {
    (this._setter = n),
      ...
      (this.effect = new eh(e, () => {
        this._dirty || ((this._dirty = !0), gg(this));
      })),
...
function oh(t) {
  (!dt.length || !dt.includes(t, qs && t.allowRecurse ? tn + 1 : tn)) &&
    (t.id == null ? dt.push(t) : dt.splice($b(t.id), 0, t), wg());
}
function wg() {
  !qs && !Yc && ((Yc = !0), (sh = _g.then(Eg)));
}
function Vb(t) {
...
const Ag = Symbol.for("v-ndc");
function Xd(t) {
  return Ve(t) ? lh(ah, t, !1) || t : t || Ag;
}
function dD(t) {
  return lh(Kb, t);
}
...
function ch(
  ...
  var a;
  const l = tg() === ((a = Xe) == null ? void 0 : a.scope) ? Xe : null;
  let c,
    u = !1,
    h = !1;
  if (
...
function Yb(t, e, n) {
  const r = this.proxy,
    i = Ve(t) ? (t.includes(".") ? kg(r, t) : () => r[t]) : t.bind(r, r);
  let s;
...
function xr(t, e) {
  ...
  else if (Jm(t)) for (const n in t) xr(t[n], e);
  return t;
}
function Jt(t, e) {
  const n = it;
...
const $t = [Function, Array],
  ...
  Jb = {
    ...
    setup(t, { slots: e }) {
      ...
      let i;
      return () => {
        const s = e.default && xg(e.default(), !0);
...
function xg(t, e = !1, n) {
  ...
  for (let s = 0; s < t.length; s++) {
    ...
    o.type === ht
      ? (o.patchFlag & 128 && i++, (r = r.concat(xg(o.children, e, a))))
...
function Og(t) {
  return t.some((e) =>
    Ps(e) ? !(e.type === Bt || (e.type === ht && !Og(e.children))) : !0
  )
    ? t
    : null;
}
...
const Zc = (t) => (t ? (zg(t) ? cl(t) || t.proxy : Zc(t.parent)) : null),
...
function d0(t) {
  const e = uh(t),
    n = t.proxy,
    r = t.ctx;
  (eu = !1), e.beforeCreate && nf(e.beforeCreate, t, "bc");
  const {
    data: i,
    computed: s,
    methods: o,
  ...
  if (a) for (const Ce in a) Dg(a[Ce], r, n, Ce);
  if (l) {
...
function Dg(t, e, n, r) {
  const i = r.includes(".") ? kg(n, r) : () => n[r];
  if (Ve(t)) {
    const s = e[t];
    le(s) && ut(i, s);
  } else if (le(t)) ut(i, t.bind(n));
  else if (Me(t))
    if (J(t)) t.forEach((s) => Dg(s, e, n, r));
    else {
...
function _0(t, e, n, r = !1) {
  const i = {},
    s = {};
  ha(s, ol, 1), (t.propsDefaults = Object.create(null)), Lg(t, e, i, s);
...
const $g = (t) => t[0] === "_" || t === "$stable",
  ...
  E0 = (t, e) => {
    if (t.vnode.shapeFlag & 32) {
      const n = e._;
      n ? ((t.slots = we(e)), ha(e, "_", n)) : Vg(e, (t.slots = {}));
    } else (t.slots = {}), e && Fg(t, e);
    ha(t.slots, ol, 1);
  },
  T0 = (t, e, n) => {
    ...
    if (r.shapeFlag & 32) {
      ...
      a
        ...
        : ((s = !e.$stable), Vg(e, i)),
        (o = e);
    } else e && (Fg(t, e), (o = { default: 1 }));
    if (s) for (const a in i) !$g(a) && o[a] == null && delete i[a];
  };
      ...
      Y && (D = D ? D.concat(Y) : Y),
        p == null
          ...
          ? (ee(p.dynamicChildren, G, w, q, P, L, D),
            (m.key != null || (q && m === q.subTree)) && Ug(p, m, !0))
...
function de(t, e, n, r, i, s) {
  return Bg(I(t, e, n, r, i, s, !0));
}
function Oe(t, e, n, r, i) {
  return Bg(xe(t, e, n, r, i, !0));
}
function Ps(t) {
...
function x0(t, e = null, n = null, r = 0, i = null, s = !1) {
  ...
  if (($0(t) && (t = t.__vccOpts), e)) {
    ...
    a && !Ve(a) && (e.class = Pn(a)),
      Me(l) && (fg(l) && !J(l) && (l = Ke({}, l)), (e.style = nr(l)));
  }
  const o = Ve(t) ? 1 : Sg(t) ? 128 : C0(t) ? 64 : Me(t) ? 4 : le(t) ? 2 : 0;
  return I(t, e, n, r, i, o, s, !0);
}
function Hg(t) {
  return t ? (fg(t) || ol in t ? Ke({}, t) : t) : null;
}
function Tn(t, e, n = !1) {
...
function N0(t, e) {
  const n = t.type;
  (t.accessCache = Object.create(null)), (t.proxy = pg(new Proxy(t.ctx, h0)));
  const { setup: r } = n;
  if (r) {
...
function cl(t) {
  if (t.exposed)
    return (
      t.exposeProxy ||
      (t.exposeProxy = new Proxy(yg(pg(t.exposed)), {
        get(e, n) {
...
function H0(t) {
  const e = {};
  for (const V in t) V in Kg || (e[V] = t[V]);
  if (t.css === !1) return e;
  const {
      name: n = "v",
      type: r,
    ...
    Te = (V) => (pe, be) => {
      ...
      Tr(_t, [pe, Re]),
        gf(() => {
          Ir(pe, V ? l : s), Bn(pe, V ? u : a), mf(_t) || vf(pe, r, v, Re);
        });
    };
  return Ke(e, {
    onBeforeEnter(V) {
...
function Ci(t, e) {
  return qe(new Error(), { type: t, [tv]: !0 }, e);
}
function dn(t, e) {
  return t instanceof Error && tv in t && (e == null || !!(t.type & e));
}
const Ff = "[^/]+?",
...
function nT(t, e) {
  ...
  function l(u) {
    ...
    for (
      ...
      h < n.length &&
      XE(u, n[h]) >= 0 &&
      (u.record.path !== n[h].record.path || !nv(u, n[h]));
...
function nv(t, e) {
  return e.children.some((n) => n === t || nv(t, n));
}
const rv = /#/g,
  oT = /&/g,
  aT = /\//g,
...
function mT(t) {
  return gh(t).replace(ov, "{").replace(av, "}").replace(sv, "^");
}
function cu(t) {
  return gh(t)
    .replace(iv, "%2B")
...
function vT(t) {
  return gh(t).replace(rv, "%23").replace(cT, "%3F");
}
function yT(t) {
...
function Kf(t) {
  const e = Yt(dl),
    ...
    s = Pe(() => i.value > -1 && ST(n.params, r.value.params)),
    o = Pe(
      () =>
        i.value > -1 &&
        i.value === n.matched.length - 1 &&
        Jg(n.params, r.value.params)
    );
  function a(l = {}) {
    return AT(l)
...
function qT(t) {
  ...
  function f(k, $) {
    let E, N;
    return (
      ev(k) ? ((E = e.getRecordMatcher(k)), (N = $)) : (N = k), e.addRoute(N, E)
    );
  }
  function g(k) {
  ...
  const hn = new Set(),
    yr = {
      ...
      install(k) {
        ...
        const E = {};
        for (const W in jn) E[W] = Pe(() => l.value[W]);
...
function ea(t, ...e) {
  sp.logLevel <= Se.ERROR && sp.error(`Auth (${no}): ${t}`, ...e);
}
/**
 * @license
 * Copyright 2020 Google LLC
  ...
  if (typeof t != "number" && t && !t.ba) {
    ...
    if (e && e[lo]) _u(e.i, t);
      ...
      e.removeEventListener
        ...
        (n = Mh(e))
          ? (_u(n, t), n.h == 0 && ((n.src = null), (e[Nh] = null)))
          : wl(t);
    }
  }
}
  ...
  try {
    if (t == this.g)
      e: {
        ...
        if (
          !(3 > u) &&
          (u != 3 || vu || (this.g && (this.h.h || this.g.fa() || xp(this.g))))
        ) {
...
function Sy(t, e, n) {
  Iy(t, e),
    0 < n.length && ((t.i = null), t.g.set(Wi(t, e), Ph(n)), (t.h += n.length));
}
z.toString = function () {
...
function Pk(t, e, n) {
  ...
  try {
    Ey(t, function (i, s) {
      let o = i;
      ao(i) && (o = Vh(i)), e.push(r + s + "=" + encodeURIComponent(o));
    });
  } catch (i) {
...
class pC extends Tt {
  ...
  matches(e) {
    const n = e.data.field(this.field);
    return ed(n) && Ks(n.arrayValue, this.value);
  }
}
class mC extends Tt {
  constructor(e, n) {
...
function jC(t, e) {
  let n;
  if (e instanceof wo) n = { update: Zp(t, e.key, e.value) };
  else if (e instanceof sd) n = { delete: Du(t, e.key) };
 ...
 */ class eq {
  ...
  isEqual(e) {
    return (
      ...
      Pi(this.mutations, e.mutations, (n, r) => Kp(n, r)) &&
      Pi(this.baseMutations, e.baseMutations, (n, r) => Kp(n, r))
    );
  }
}
class ad {
  ...
  _o(e, n, r) {
    ...
    return (
      ...
      f(c, Uo.EventType.ERROR, (g) => {
        h ||
          ((h = !0),
          Np("Connection", "WebChannel transport errored:", g),
...
function O_(t, e) {
  const n = ce(t);
  n.du.has(e.targetId) ||
    (n.du.set(e.targetId, e), fd(n) ? dd(n) : Yi(n).ko() && hd(n, e));
}
function D_(t, e) {
  const n = ce(t),
    r = Yi(n);
...
async function gd(t, e) {
  ...
  if ((s || ((i = !0), (s = new Wq())), i))
    try {
      ...
      const a = md(o, `Initialization of query '${Ou(e.query)}' failed`);
...
async function t1(t, e, n, r) {
  t.dc = (u, h, d) =>
    (async function (f, g, v, _) {
      let b = g.view.ju(v);
      b.$i &&
        (b = await em(f.localStore, g.query, !1).then(({ documents: A }) =>
          g.view.ju(A, b)
        ));
      const y = _ && _.targetChanges.get(g.targetId),
        x = g.view.applyChanges(b, f.isPrimaryClient, y);
      return om(f, g.targetId, x.Yu), x.snapshot;
    })(t, u, h, d);
      ...
      r = (function (i, s, o, a, l, c, u) {
        ...
        if (l.isKeyField()) {
          ...
          if (c === "in" || c === "not-in") {
            fm(u, c);
            const f = [];
            for (const g of u) f.push(dm(a, i, g));
...
const cw = {
  ...
  uw = (t) => (Hi("data-v-a1e4e96e"), (t = t()), zi(), t),
  z1 = { class: "header" },
  ...
  J1 = al(
    '<a href="https://www.catarse.me/crisordemparanormal" target="_blank" data-v-a1e4e96e><h3 class="agents-login" data-v-a1e4e96e> Rank </h3></a><div class="icons-container" data-v-a1e4e96e><a class="discord-link" href="https://discord.gg/crisordemparanormal" target="_blank" data-v-a1e4e96e><img class="icon" src="' +
      ...
      PT +
      '" alt="twitter" data-v-a1e4e96e></a><a class="discord-link" href="https://www.twitch.tv/powered_by_soul" target="_blank" data-v-a1e4e96e><img class="icon-twitch" src="' +
      OT +
      '" alt="twitch" data-v-a1e4e96e></a></div>',
    2
  ),
  Z1 = { key: 1 },
  ex = { key: 0 },
  ...
  lx = Zi(ax, [["__scopeId", "data-v-a1e4e96e"]]),
  cx =
  ...
  Io = (t) => (Hi("data-v-fdae9d61"), (t = t()), zi(), t),
  ...
  Cx = [kx],
  qx = al(
    '<div class="discord-link" data-v-fdae9d61><a href="https://discord.gg/crisordemparanormal" target="_blank" data-v-fdae9d61> Discord </a></div><div class="discord-link" data-v-fdae9d61><a href="https://twitter.com/CrisOrdemPrnml" target="_blank" data-v-fdae9d61> Twitter </a></div><div class="discord-link" data-v-fdae9d61><a href="https://www.twitch.tv/powered_by_soul" target="_blank" data-v-fdae9d61> Twitch </a></div>',
    3
  ),
  xx = at({
  ...
  Rx = Zi(xx, [["__scopeId", "data-v-fdae9d61"]]),
  Px = { key: 0 },
  Ox = at({
    __name: "HeaderView",
    setup(t) {
      const e = lv(),
        { width: n } = Xg(),
        r = Pe(() => e.path),
        i = Pe(() => !r.value.includes("/agente/stream/"));
      return (s, o) =>
        i.value
          ? (j(),
            de("div", Px, [
  ...
  qd = (t) => (Hi("data-v-9643cc4a"), (t = t()), zi(), t),
  ...
  Zx = at({
    ...
    setup(t) {
      const e = ue([]),
        ...
        a = (d) => {
          var f;
          return (f = window.open(d, "_blank")) == null ? void 0 : f.focus();
        },
        l = () => (s.value = !0),
        c = () => {
        ...
        h = () => {
          setTimeout(() => {
            i.value < e.value.length - 1 ? i.value++ : (i.value = 0), l(), h();
          }, Jx);
        };
      return (
        ut(s, () => {
              ...
              de("div", Gx, [
                I("div", Qx, [
                  I(
                    "img",
                    {
                      src: e.value[i.value].imgPath,
                      alt: e.value[i.value].imgAlt,
                      class: "ad-img",
                      onClick:
                        f[0] || (f[0] = (g) => a(e.value[i.value].adLink)),
                    },
                    null,
                    8,
                    Yx
  ...
  eR = Zi(Zx, [["__scopeId", "data-v-3c32c01c"]]),
  ...
  WR = Lt(() =>
    I("h2", { class: "content-title" }, " Join the Order ", -1)
  ),
  KR = Lt(() =>
    I(
      "p",
  ...
  dw = qT({
    ...
    routes: [
      { path: "/", name: "home", component: XR },
      {
        ...
        name: "login-page",
        component: () =>
          S(() => import("./LoginPage-EzhFUP1n.js"), __vite__mapDeps([0, 1])),
      },
      {
        path: "/agentes",
        name: "character-list",
        component: () =>
          S(
            () => import("./CharacterList-TBMgkAYI.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CampaignsList-Hl3Uiluh.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./HomebrewList-3u0Yr8ug.js"),
            __vite__mapDeps([
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./HomebrewPowerView-a9naV5Zi.js"),
            __vite__mapDeps([
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./HomebrewRitualView-Cn7eeLwh.js"),
            __vite__mapDeps([
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./HomebrewItemView-tw8ZkgHu.js"),
            __vite__mapDeps([
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./HomebrewCreatureView-TkzC0aVG.js"),
            __vite__mapDeps([
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./UserProfile-Bc67EXHV.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CampaignCreate-V3ZevHsD.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CampaignEdit-uHV2gPhm.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CampaignPage-7bnH-V_6.js"),
            __vite__mapDeps([
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CampaignJoin-W5g-w_bg.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CampaignAddAgent-6BW2maAk.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CreateCombat-yab6llEH.js"),
            __vite__mapDeps([
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CampaignPageDenied-pPoOyqie.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./MasterScreen-SvU7114k.js"),
            __vite__mapDeps([
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CharacterCreation-zLyQTdTP.js"),
            __vite__mapDeps([
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CharacterSheet-pnnT2Dx-.js"),
            __vite__mapDeps([
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./ContactView-VVdHizZv.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CharacterStream-5BBvOgCk.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CharacterPv-vl2Gq-mz.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CharacterSan-0u6FZbEf.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CharacterPe-N1mSHmBM.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./privacy-policy-k_GtCGy0.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CreaturesList-ODyi78Bn.js"),
            __vite__mapDeps([
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./CreatureSheet-Nw5rssMT.js"),
            __vite__mapDeps([
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./persona-5-strikers-a-continuacao-eletrizante-de-uma-jornada-inesquecivel-AWwqhTbp.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./the-witcher-3-wild-hunt-um-rpg-de-acao-com-uma-narrativa-rica-e-um-vasto-mundo-aberto-AwsmAXx9.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./mass-effect-legendary-edition-uma-jornada-remasterizada-pelos-confins-da-galaxia-NL1lYS1H.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./genshin-impact-uma-jornada-alem-dos-limites-Hmw1RNHk.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./final-fantasy-xiv-uma-odisseia-virtual-com-comunidade-forte-e-narrativa-imersiva-anvpzLPd.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./elden-ring-a-jornada-epica-alem-das-expectativas-tmUiWCkp.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./divinity-original-sin-2-desbravando-os-mundos-magicos-do-rpg-tatico-cooperativo-vQkBG4Tu.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./cyberpunk-2077-um-rpg-de-acao-futurista-dos-criadores-de-the-witcher-3-VTkGFL_p.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./assassins-creed-valhalla-a-fusao-magnifica-entre-acao-e-rpg-xOnkERaC.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./o-que-e-rpg-de-mesa-76nb3Tp8.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./o-rpg-ordem-paranormal-DqJ4hC1y.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./o-rpg-tormenta20-LK5xeFIl.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./3d_t-a-porta-de-entrada-pro-rpg-brasileiro-wCdhKxTB.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./vampiro-a-mascara-perdura-ao-longo-das-decadas-A856DcD-.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./a-popularizacao-de-dungeons-_-dragons-e41O3t2R.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./criando-personagens-memoraveis-em-rpg-de-mesa-ujnMSHi2.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./diferentes-estilos-de-mestres-em-rpg-de-mesa-Oqt0s934.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./historia-do-rpg-uma-viagem-pela-evolucao-do-genero-XsVXQcja.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./gurps-o-rpg-generico-02t2LO_H.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./pathfinder-o-maior-rival-de-dungeons-_-dragons-uiam253s.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./um-guia-completo-sobre-pathfinder-eJHkUXWH.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./os-sistemas-mais-faceis-e-mais-dificeis-de-rpg-de-mesa-1JYmQiz0.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./fate-core-system-e-o-sistema-mais-facil-do-mundo-MoGuWJrg.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./dicas-para-mestres-de-rpg-bQnaB9b_.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./criando-um-mundo-de-rpg-personalizado-l3pZ8oQw.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./a-psicologia-do-rpg-influencias-na-tomada-de-decisoes-criatividade-e-pensamento-estrategico-ES64NnkN.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./os-beneficios-do-rpg-para-a-vida-real-49yokfqk.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./a-influencia-de-d_d-na-cultura-pop-rEPbXIWQ.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./a-evolucao-das-mecanicas-de-rpg-vGCQGNxi.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./racas-e-classes-explorando-as-escolhas-de-personagem-e06fMSvr.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./o-papel-do-mestre-na-narrativa-de-rpg-b-0uZVWK.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./mundos-de-campanhas-de-rpg-famosos-forgotten-realms-greyhawk-eberron-82bg6Vw-.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import("./o-impacto-da-arte-na-estetica-dos-rpgs-uLu0Kfrh.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./a-psicologia-por-tras-das-escolhas-de-personagens-de-rpg-MTwePIsg.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./mitos-e-lendas-folcloricas-no-mundo-dos-rpgs-YXjCFCaR.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./o-uso-de-suplementos-e-modulos-de-aventuras-no-rpg-de-mesa-YA7ClOFt.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./rpgs-alem-do-medieval-fantastico-explorando-rpgs-que-fogem-do-cenario-medieval-HsB04u-X.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./como-criar-encontros-e-desafios-equilibrados-rpg-de-mesa-XAB1T40z.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import("./descobrindo-o-mundo-do-rpg-savage-worlds-l8suVKQc.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./explorando-os-subgeneros-do-rpg-k0g6jtYP.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./baldurs-gate-3-o-sucesso-que-esta-encantando-os-jogadores-REQ6E_Gl.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./descobrindo-as-qualidades-e-diferencas-do-rpg-apocalypse-world-YdnvenMW.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./descobrindo-o-universo-do-rpg-world-of-darkness-2NBA18bp.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./e-dificil-comecar-a-jogar-rpg-de-mesa-uUxNZFnH.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./a-importancia-da-cooperacao-em-jogos-de-rpg-0pc6NxQD.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./criando-e-mantendo-uma-campanha-de-rpg-de-longo-prazo-YW7bx9aj.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import("./o-rpg-como-pilar-da-cultura-geek-e-nerd-yRa-xmHx.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./criando-personagens-complexos-e-multidimensionais-no-rpg-jl2lkZwt.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./a-psicologia-da-imersao-em-jogos-de-rpg-de-mesa-Kl85roqx.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./construindo-mundos-de-campanha-de-rpg-atrativos-87j99y5u.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./o-papel-da-musica-e-da-trilha-sonora-em-jogos-de-rpg-UX1PLpy0.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import("./as-origens-e-a-evolucao-dos-dados-de-rpg-Vw4hHzqv.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./rpg-como-ferramenta-de-aprendizado-wgSgTsNN.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./inclusao-de-elementos-da-cultura-pop-em-campanhas-de-rpg-wDiuwz5C.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./o-impacto-dos-livros-de-aventura-oficiais-em-campanhas-de-rpg-8DWptkLU.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./rpgs-para-criancas-e-iniciantes-BtELIapn.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import("./etica-e-responsabilidade-em-jogos-de-rpg-N5foAxdO.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./o-uso-de-ferramentas-digitais-em-mesas-de-rpg-fJUZqvND.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./criando-e-jogando-em-cenarios-de-rpg-pos-apocalipticos-PFkDJmPP.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./a-influencia-das-artes-marciais-em-personagens-de-rpg-9i5tYlf8.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./a-diversidade-de-estilos-de-narrativa-em-rpg-3f3g0f5l.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./o-uso-terapeutico-dos-jogos-de-rpg-APPWP1Pi.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./diferenca_entre_rpgs_de_mesa_e_rpgs_eletronicos-_Olwxdo4.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./evolucao_das_mecanicas_de_rpg_de_gygax_a_gurps-VXIs8CNK.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import("./influencia_da_mitologia_em_jogos_de_rpg-yg31G7LM.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./rgps_de_super_herois_explorando_os_poderes_e_desafios_um_guia_sobre_como_jogar_rpgs_de_super_herois-GwsCfgVr.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./impacto_da_tecnologia_rpgs_de_realidade_virtual_e_aumentada-5_Okq4wi.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./mundo_das_miniaturas_e_cenarios_personalizados-VU0v0Gsp.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./evolucao_do_rpg_mobile_jogos_de_rpg_para_dispositivos_moveis-bjYz-ZQE.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./historia_e_a_evolucao_dos_larp_live_action_role_playing-qy0H7kBO.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./jogos_de_rpg_e_empreendedorismo_criando_e_publicando_seu_proprio_rpg-KPVNpFrG.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./uso_de_enigmas_e_quebra_cabecas_em_campanhas_de_rpg-AIlzQIZY.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./mundos_de_rpg_baseados_em_literatura_classica_cenarios_de_sherlock_holmes_ou_alice_no_pais_das_maravilhas-rBFVnP6P.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./psicologia_dos_viloes_em_rpg_criando_antagonistas_cativantes--mJL9Ccp.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./papel_das_ferramentas_de_software_em_jogos_de_rpg-PNzsiEev.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./historia_de_sucesso_no_mundo_dos_rpgs_de_jogadores_a_autores_de_jogos-zRjriaHG.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import("./explorando_a_cultura_do_cosplay_em_rpg-xD1qALYU.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./rpgs_de_construcao_de_imperios_explorando_o_aspecto_estrategico-a-wMXOrM.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./uso_de_simbologia_e_mitologia_em_rpgs-N_o-5dFz.js"),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./economia_nos_mundos_de_rpg_moedas_e_comercio-kXO-xm6X.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./importancia_da_diversidade_e_representacao_nos_jogos-rEGxSM-5.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () =>
              import(
                "./futuro_dos_jogos_em_nuvem_streaming_plataformas_de_assinaturas-eJ8IQRRc.js"
              ),
      ...
      },
      {
        ...
        component: () =>
          S(
            () => import("./NotFoundView-DPHuk3vI.js"),
        ...
        },
        {
          ...
          value: function (r) {
            if (
              ...
              if (!r.shiftKey)
                return !document.activeElement || vm(this.lastElement())
                  ? (this.firstElement().focus(), void r.preventDefault())
                  : void 0;
              vm(this.firstElement()) &&
...
if (typeof window < "u") {
  ...
  window.addEventListener("testPassive", null, wm),
    window.removeEventListener("testPassive", null, wm);
}
var Ts,
  Is,
  fw =
          ...
          fw
            ? ((t.ontouchstart = function (r) {
                r.targetTouches.length === 1 &&
                  (bm = r.targetTouches[0].clientY);
              }),
              (t.ontouchmove = function (r) {
                r.targetTouches.length === 1 &&
                  (function (i, s) {
                    (la = i.targetTouches[0].clientY - bm),
                      !pw(i.target) &&
      ...
      return (
        ...
        }),
        {
          ...
          beforeModalLeave: function () {
            (v.value = Im), h.enabled() && h.disable();
          },
...
var yw = {
  ...
  mounted() {
    ...
    Cm
      ? ((this.quill = new Cm(this.$refs.editorElement, t)),
        this.initQuill(),
        this.handleLoad())
      : S(
...
function zu(t) {
  const e = mr(t);
  let n = Rm(t);
  for (; n && BP(n) && getComputedStyle(n).position === "static"; ) n = Rm(n);
  return n &&
    (xn(n) === "html" ||
  ...
  const s = [...(n === "clippingParents" ? XP(e) : [].concat(n)), r],
    ...
    a = s.reduce((l, c) => {
      ...
      return (
        ...
        (l.right = xm(u.right, l.right)),
        (l.bottom = xm(u.bottom, l.bottom)),
...
const ZP = {
    getElementRects: (t) => {
      ...
      return { reference: HP(e, zu(n), r), floating: { ...Pm(n), x: 0, y: 0 } };
    },
...
var tO = Object.defineProperty,
  ...
  Nm = (t, e, n) =>
    e in t
      ...
      : (t[e] = n),
  pn = (t, e) => {
    for (var n in e || (e = {})) iO.call(e, n) && Nm(t, n, e[n]);
    if (Dm) for (var n of Dm(e)) sO.call(e, n) && Nm(t, n, e[n]);
    return t;
  },
  So = (t, e) => nO(t, rO(e));
function Aw(t, e) {
...
typeof document < "u" &&
  ...
  (Sw
    ...
    : (window.addEventListener("mousedown", Bm, !0),
...
function qw(t, e = !1) {
  ...
  for (let r = Gt.length - 1; r >= 0; r--) {
    ...
    try {
      ...
      (i.$_pendingHide = !1),
        requestAnimationFrame(() => {
          if (((i.$_pendingHide = !1), !n[i.randomId] && jm(i, s, t))) {
            if (
            ...
            for (; o && jm(o, o.$_containsGlobalTarget, t); ) {
...
function fO(t, e, n, r, i, s) {
  return (
    ...
    de(
      ...
      [Ii(t.$slots, "default", nb(Hg(t.slotData)))],
      2
    )
  );
}
  ...
  return (
    ...
    de(
      "div",
      {
        ...
        onKeyup:
          e[2] || (e[2] = Gg((a) => t.autoHide && t.$emit("hide"), ["esc"])),
      },
      [
        I("div", {
...
const CO = at(So(pn({}, Dd), { name: "VDropdown", vPopperTheme: "dropdown" })),
  qO = at(So(pn({}, Dd), { name: "VMenu", vPopperTheme: "menu" })),
  xO = at(So(pn({}, Dd), { name: "VTooltip", vPopperTheme: "tooltip" })),
  RO = at({
...
function Hm(t, { value: e, modifiers: n }) {
  const r = Dw(t, e, n);
...
var UO = {
  beforeMount(t, { value: e, modifiers: n }) {
    (t.$_closePopoverModifiers = n), (typeof e > "u" || e) && zm(t);
  },
  updated(t, { value: e, oldValue: n, modifiers: r }) {
    (t.$_closePopoverModifiers = r),
      e !== n && (typeof e > "u" || e ? zm(t) : Wm(t));
  },
  beforeUnmount(t) {
    Wm(t);
  },
...
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = [
      "assets/LoginPage-EzhFUP1n.js",
      "assets/LoginPage-eaGdDaNQ.css",
      "assets/CharacterList-TBMgkAYI.js",
      "assets/LoadingView-pI56421r.js",
      "assets/LoadingView-qh-7N428.css",
      "assets/SearchInput-iKq3Myyd.js",
      "assets/SearchInput-LEjlhuSA.css",
      "assets/ToastNotification-_9eYhDMT.js",
      "assets/ToastNotification-yhyaH9rC.css",
      "assets/CharacterCard-jtLRDUA4.js",
      "assets/open-in-new-icon-p91krxL-.js",
      "assets/CharacterCard-9d6BWOZG.css",
      "assets/firebase-Kb29IuDF.js",
      "assets/CharacterList-Fw_kB2IC.css",
      "assets/CampaignsList-Hl3Uiluh.js",
      "assets/CampaignsList-vV8BsU8v.css",
      "assets/HomebrewList-3u0Yr8ug.js",
      "assets/TabNav-ynhTYBUU.js",
      "assets/TabNav-EPczaBrR.css",
      "assets/HomebrewItems-DkaYw940.js",
      "assets/PowerCard-Xw1AdoxN.js",
      ...
      "assets/RitualCard-d1m9ck3I.js",
      "assets/d20-icon-vaz1En3o.js",
      "assets/RitualCard-YjXbv06p.css",
      "assets/DropdownSimple-q8vHsdKA.js",
      "assets/DropdownSimple-Fkf-Qfr8.css",
      "assets/CursedItemCard-7RNt5kH1.js",
      "assets/CursedItemCard-cVIajowH.css",
      "assets/HomebrewItems-nVs-RNaZ.css",
      "assets/CreatureCard-G1XhBX9Z.js",
      "assets/CreatureCard-ANgcNO-8.css",
      "assets/PrivateFeat-K0XA_9_f.js",
      "assets/PrivateFeat-Pey8Uhe4.css",
      "assets/CreatureForm-xjqSSPNi.js",
      "assets/blank-profile-picture-wMh28flS.js",
      "assets/creatureData-jLpja1fz.js",
      "assets/PictureModal-xqB58BAq.js",
      "assets/index.esm2017-MWh9Og-u.js",
      ...
      "assets/HomebrewPowerView-a9naV5Zi.js",
      "assets/PlayerCard-gvg0XxcA.js",
      "assets/colors-NalZ6sWE.js",
      "assets/PlayerCard-uyIvYeuE.css",
      "assets/HomebrewPowerView-oH1rxoLq.css",
      "assets/HomebrewRitualView-Cn7eeLwh.js",
      "assets/HomebrewRitualView-A5dhjcNK.css",
      "assets/HomebrewItemView-tw8ZkgHu.js",
      "assets/HomebrewItemView-xVelEn5u.css",
      "assets/HomebrewCreatureView-TkzC0aVG.js",
      "assets/HomebrewCreatureView-p5Bsn7sU.css",
      "assets/UserProfile-Bc67EXHV.js",
      "assets/UserProfile-nBvv8kym.css",
      "assets/CampaignCreate-V3ZevHsD.js",
      "assets/SwitchButtonBool-dB-QOehp.js",
      "assets/SwitchButtonBool-VT84EvRG.css",
      "assets/CampaignCreate-ZGKciBb7.css",
      "assets/CampaignEdit-uHV2gPhm.js",
      "assets/CampaignEdit-g3a8pHRX.css",
      "assets/CampaignPage-7bnH-V_6.js",
      "assets/CombatCard-figlkB6N.js",
      "assets/CombatCard-B8Jbf4SW.css",
      "assets/CampaignPage-rxEkD6sn.css",
      "assets/CampaignJoin-W5g-w_bg.js",
      "assets/CampaignJoin-Y3mQwTGd.css",
      "assets/CampaignAddAgent-6BW2maAk.js",
      "assets/CampaignAddAgent-ak7wNOog.css",
      "assets/CreateCombat-yab6llEH.js",
      "assets/creatures-8h8lib79.js",
      "assets/CreateCombat-NQ3F2-l1.css",
      "assets/EditCombat-eas-0WN1.js",
      "assets/EditCombat-hUNmCuzT.css",
      "assets/CampaignPageDenied-pPoOyqie.js",
      "assets/CampaignPageDenied-gbq2rXKF.css",
      "assets/MasterScreen-SvU7114k.js",
      "assets/characterSheetUtils-F9SJIHlA.js",
      "assets/edit-icon-u1vf_q3w.js",
      "assets/classes-7dZTyOHx.js",
      "assets/skills-siTAQjCS.js",
      "assets/characterSheetUtils-ssRZxcFI.css",
      "assets/ActionModal-5_Bb2uOg.js",
      "assets/ActionModal-LJbZcYkK.css",
      "assets/MasterScreen-Ofo4qbMp.css",
      "assets/CharacterCreation-zLyQTdTP.js",
      "assets/ClassCard-4_QMCX3S.js",
      "assets/ClassCard-P-qZoCAy.css",
