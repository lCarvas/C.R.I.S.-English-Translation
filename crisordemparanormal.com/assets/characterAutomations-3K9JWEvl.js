const o = [
  ...
  s = [
    {
      label: "Anfitrião",
      img: "/img/skins/anfitriao-skin-dice-icon.webp",
      color: "#EA17DC",
      isSolid: !0,
      background:
        "url('/img/skins/anfitriao-background-skin-dice-icon.webp') center / cover no-repeat",
    },
    {
      label: "O Deus da Morte",
      img: "/img/skins/deus-morte-skin-dice-icon.webp",
      color: "#8E8E8E",
      isSolid: !0,
      background:
        "url('/img/skins/deus-morte-background-skin-dice-icon.webp') center / cover no-repeat",
    },
    {
      label: "O Diabo",
      img: "/img/skins/diabo-skin-dice-icon.webp",
      color: "#C21801",
      isSolid: !0,
      background:
        "url('/img/skins/diabo-background-skin-dice-icon.webp') center / cover no-repeat",
    },
    {
      label: "Máscara do Desespero",
      img: "/img/skins/magistrada-skin-dice-icon.webp",
      color: "#EEA827",
      isSolid: !0,
      background:
        "url('/img/skins/magistrada-background-skin-dice-icon.webp') center / cover no-repeat",
    },
  ],
  r = [
    {
  ...
  t = [
    {
      ...
      onAdd(e) {
        ((e.maxPe += a[e.nex]), (e.currentPe += a[e.nex]));
      },
      onRemove(e) {
        ((e.maxPe -= a[e.nex]),
          (e.currentPe -= a[e.nex]),
    ...
    },
    {
      id: "sangue-de-ferro",
      onAdd(e) {
        ((e.maxPv += a[e.nex] * 2), (e.currentPv += a[e.nex] * 2));
      },
      onRemove(e) {
        ((e.maxPv -= a[e.nex] * 2),
          (e.currentPv -= a[e.nex] * 2),
          e.maxPv <= 0 && (e.maxPv = 0),
          e.currentPv <= 0 && (e.currentPv = 0));
      },
      onNexUp(e) {
        ((e.maxPv += 2), (e.currentPv += 2));
      },
      onNexDown(e) {
        ((e.maxPv -= 2),
          (e.currentPv -= 2),
    ...
    },
    {
      id: "calejado",
      onAdd(e) {
        ((e.maxPv += a[e.nex]), (e.currentPv += a[e.nex]));
      },
      onRemove(e) {
        ((e.maxPv -= a[e.nex]),
          (e.currentPv -= a[e.nex]),
    ...
    {
      id: "mobilidade-acrobatica",
      onAdd(e) {
        ((e.bonusDefense += 2), (e.movement += 3));
      },
      onRemove(e) {
        ((e.bonusDefense -= 2),
          (e.movement -= 3),
          e.bonusDefense <= 0 && (e.bonusDefense = 0),
    ...
    },
    {
      ...
      onRemove(e) {
        ((e.bonusDefense -= 2), e.bonusDefense <= 0 && (e.bonusDefense = 0));
      },
    },
    {
      id: "dedicacao",
      onAdd(e) {
        ((e.maxPe += Math.floor(1 + ((a[e.nex] * 1) / 2 - 1))),
          (e.currentPe += Math.floor(1 + ((a[e.nex] * 1) / 2 - 1))),
          e.peTurn || (e.peTurn = "1"),
          (e.peTurn = Math.floor(parseInt(e.peTurn) + 1).toString()));
      },
      onRemove(e) {
        ((e.maxPe -= Math.floor(1 + ((a[e.nex] * 1) / 2 - 1))),
          (e.currentPe -= Math.floor(1 + ((a[e.nex] * 1) / 2 - 1))),
      ...
      onNexUp(e) {
        (a[e.nex] % 2 !== 0 && e.maxPe++, a[e.nex] % 2 !== 0 && e.currentPe++);
      },
      onNexDown(e) {
        (a[e.nex] % 2 !== 0 && e.maxPe--,
          a[e.nex] % 2 !== 0 && e.currentPe--,
          e.maxPe <= 1 && (e.maxPe = 1),
          e.currentPe <= 1 && (e.currentPe = 1));
      },
    },
    {
      id: "cicatrizes-psicologicas",
      onAdd(e) {
        ((e.maxSan += a[e.nex]), (e.currentSan += a[e.nex]));
      },
      onRemove(e) {
        ((e.maxSan -= a[e.nex]), (e.currentSan -= a[e.nex]));
      },
      onNexUp(e) {
        (e.maxSan++, e.currentSan++);
      },
      onNexDown(e) {
        (e.maxSan--, e.currentSan--);
      },
    ...
    },
    {
      id: "nex-40%-gatuno",
      onAdd(e) {
        ((e.skills[3].otherBonus += 5), (e.skills[6].otherBonus += 5));
      },
      onRemove(e) {
        ((e.skills[3].otherBonus -= 5),
          (e.skills[6].otherBonus -= 5),
          e.skills[3].otherBonus <= 0 && (e.skills[3].otherBonus = 0),
          e.skills[6].otherBonus <= 0 && (e.skills[3].otherBonus = 0));
      },
    },
    {
      id: "nex-65%-rituais-eficientes",
      onAdd(e) {
        e.ritualsDc += 5;
      },
      onRemove(e) {
        ((e.ritualsDc -= 5), e.ritualsDc <= 1 && (e.ritualsDc = 1));
      },
    },
  ];
export { o as S, t as c, i as e, n as o, s as r, r as s };
