const e = "/assets/attributes-V37qZCrP.png",
  a = {
    name: "Mundane",
    shortDescription:
      "Você é uma pessoa comum, com uma ocupação regular e uma vida normal. Claro, considerando que você é um personagem de Ordem Paranormal RPG, essa normalidade toda não vai durar muito...",
    description: "",
    initialPv: 8,
    levelPv: 0,
    initialPe: 1,
          ...
          abilities: [
            {
              ...
              description:
                "<p>Você recebe +1 PV para cada 5% de NEX e, quando faz um bloqueio, soma seu Vigor na resistência a dano recebida.</p>",
            },
            {
            ...
            },
            {
              ...
              description:
                "<p>Ao sofrer dano não paranormal, você pode gastar uma reação e 2 PE para reduzir esse dano à metade. Em NEX 85%, você pode usar esta habilidade para reduzir dano paranormal.</p>",
            },
            {
          ...
          abilities: [
            {
              ...
              description:
                "<p>Você sabe atingir os pontos vitais de um inimigo distraído. Uma vez por rodada, quando atinge um alvo desprevenido com um ataque corpo a corpo ou em alcance curto, ou um alvo que você esteja flanqueando, você pode gastar 1 PE para causar +1d6 pontos de dano do mesmo tipo da arma. Em NEX 40% o dano adicional aumenta para +2d6, em NEX 65% aumenta para +3d6 e em NEX 99% aumenta para +4d6.</p>",
            },
            {
              name: "NEX 40% - Gatuno",
              description:
          ...
          abilities: [
            {
              ...
              description:
                "<p>Você pode usar uma ação padrão e 2 PE para curar 2d10 pontos de vida a de si mesmo ou de um aliado adjacente. Você pode curar +1d10 PV respectivamente em NEX 40%, 65% e 99%, gastando +1 PE por dado adicional de cura.</p>",
            },
            {
        ...
        },
        {
          ...
          abilities: [
            ...
            },
            {
              ...
              description:
                "<p>Você pode gastar uma ação padrão e 4 PE para inspirar seus aliados com suas palavras. Você e todos os seus aliados em alcance curto ganham +1d20 em testes de perícia até o fim da cena. A partir de NEX 65%, você pode gastar 8 PE para fornecer um bônus total de +2d20.</p>",
            },
            {
    ...
    },
    {
      ...
      powers: [
        ...
        },
        {
          name: "Criar Selo",
          description:
            "<p>Você sabe fabricar selos paranormais de rituais que conheça. Fabricar um selo gasta uma ação de interlúdio e um número de PE iguais ao custo de conjurar o ritual. Você pode ter um número máximo de selos criados a qualquer momento igual à sua Presença.</p>",
        },
        {
          ...
          abilities: [
            {
              ...
              description:
                "<p>Ao conjurar um ritual, você pode gastar seus próprios pontos de vida para pagar o custo em pontos de esforço, à taxa de 2 PV por PE pago. Pontos de vida gastos dessa forma só podem ser recuperados com descanso.</p>",
            },
            {
              name: "NEX 40% - Abraçar a Dor",
              description:
                "<p>Sempre que sofrer dano não paranormal, você pode gastar uma reação e 2 PE para reduzir esse dano à metade.</p>",
            },
            {
