const e = [
  ...
  },
  {
    ...
    loadPenalty: !1,
    description:
      "<p>You convince people with cunningness and convincing arguments.</p><p><span>Soothe (trained, DT 20).</span> You stabilize an adjacent character who is going crazy, causing him to stay at Sanity 1. The DC increases by +5 for each time they have been soothed during the scene. This uses one standard action.</p><p><span>Change Attitude.</span> You change the category of an NPC's attitude towards you or someone else (see the next page for the explanation of attitude categories). Make a Diplomacy check opposed by the target's Will check. If you pass, you change their attitude up or down one category, your choice. If you pass by 10 or more, their attitude changes by up to two categories. If failed by 5 or more, the target's attitude shifts one category in the opposite direction. This action takes one minute. You can take -2d20 on the check to do so as a complete action (to avoid a fight, for example). You can only change a person's attitude once per day.</p><p><span>Persuasion (DC 20).</span> You convince a person to do something, such as answer a question or do a favor. If that thing is costly (like borrowing a car) you suffer -5 on your roll. If it is dangerous (like committing a crime) you suffer -10 or automatically fail. By the GM's choice, your roll may be opposed by the person's Will check. This action takes a minute or more, according to the GM's choice.</p>",
  },
  {
    name: "Deception",
    attribute: "PRE",
    ...
    loadPenalty: !1,
    description:
      "<p>You manipulate people with bluffs and trickery.</p><p><span>Disguise (Trained).</span> You change your or someone else's appearance. Make a Deception check opposed by the Perception check of anyone paying attention to the disguised person. If you pass, the diguise goes unnoticed; otherwise, they realize something is wrong. If the disguise is that of a specific person, those who know that person receive +10 on the Perception check. A disguise requires at least ten minutes and a disguise kit. Without it, you suffer -5 on the check.</p><p><span>Forgery (Veteran).</span> You forge a document. Make a Deception check opposed by the Perception check of anyone examining the document. If you pass, the person believes it is valid; otherwise, they realize it is false. If the document is very complex, or includes a specific signature or stamp, you suffer -2d20 on the check.</p><p><span>Feint (Trained).</span> You can use a standard action and make a Deception check opposed to a Reflexes check from a being at close range. If you pass, he is off guard against your next attack, if made until the end of their next turn.</p><p><span>Insinuation (DC 20).</span> You say something to someone without other people understanding what you are talking about. If you pass, the receiver understands your message. If you fail by 5 or more, they understand something other than what you wanted to convey. Other people can make an Intuition check opposed to your Deception check. If they pass, they understand what you're saying.</p><p><span>Intrigue (DC 20).</span> You spread gossip. For example, you can say that the bar owner is watering down the beer to anger the people against him. Very unlikely intrigues (convincing people that the delegate is an ET who is abducting people) have DC 30. This action requires at least a day, but may take longer, according to the GM. A person can investigate the source of the gossip and reach you. This requires an Investigation check on their part, with a DC equal to the result of your Intrigue check.</p><p><span>Lying.</span> You make a person believe something that isn't true. Your check is opposed by the victim's Intuition check. Very implausible lies impose a -2d20 penalty on your check (“Why do I have the head of security’s badge? Why, because he dropped it and I’m going to return it!”).</p>",
  },
  {
    name: "Fortitude",
    attribute: "VIG",
    ...
    loadPenalty: !1,
    description:
      "<p>You use this skill as a save throw against effects that require vitality, such as diseases and poisons. The DC is determined by the effect. You also use Fortitude to maintain your breath when running or not breathing. The DC is 5 + 5 per previous check (see the Athletics skill for more details).</p>",
  },
  {
    name: "Stealth",
    attribute: "AGI",
    ...
    loadPenalty: !0,
    description:
      "<p>You know how to be discreet and sneaky.</p><p><span>Hide.</span> Make a Stealth check opposed by Perception checks of anyone who might notice you. Everyone that fails cannot notice you (you have total camouflage against them). Hiding is a free action that you can only do at the end of your turn and only if you end your turn in a place where you can hide (behind a door, in a dark room, in dense woods, in the middle of a crowd...). If you moved during your turn, you suffer -1d20 on the check (you can move at half your normal movement value to avoid this penalty). If you attacked or did a very flashy action, you suffer -3d20.</p><p><span>Follow.</span> Make a Stealth check opposed to the Perception check of the person being followed. You suffer -5 if you are in a place with no hiding spots or movement, such as an open field or deserted street. The victim receives +5 to their Perception check if they are taking precautions to avoid being followed (such as looking behind him occasionally). If you pass, you follow the person until they reach their destination. If you fail, the person realizes it halfway.</p>",
  },
  {
    name: "Iniciative",
    attribute: "AGI",
    ...
    loadPenalty: !1,
    description:
      "<p>This skill determines your reaction speed. When an action scene begins, each character involved makes an Initiative roll. They then act in descending order of results.</p>",
  },
  {
    name: "Intimidation",
    attribute: "PRE",
  ...
  },
  {
    ...
    loadPenalty: !1,
    description:
      "<p>This skill measures your empathy and “sixth sense”.</p><p><span>Perceive Lies.</span> You can tell if someone is lying (see the Deception skill).</p><p><span>Premonition (trained, DT 20).</span> You analyze a person, to get an idea of their nature or character, or a situation, to notice any strange fact (for example, if the inhabitants of a small town are acting strangely). This use only indicates if there is something abnormal; to find out the cause, see the Investigation skill.</p>",
  },
  {
    name: "Investigation",
    attribute: "INT",
    ...
    loadPenalty: !1,
    description:
      "<p>You know how to uncover clues and informations.</p><p><span>Interrogate.</span> You uncover informations by asking around or going to a busy place and keeping your ears open. General informations (“Who is the owner of this restaurant?”) do not require testing. Restricted informations, which few people know (“Who is the delegate in charge of this case?”), has DC 20. Confidential information, or information that could put anyone who talks about it at risk, has DC 30. This action takes from an hour to a day, at the GM's discretion.</p><p><span>Search.</span> You examine a location. The DC varies: 15 for a discreet item or in a mess, but not necessarily hidden; 20 for a hidden item (safe behind a painting, document in the false bottom of a drawer); 30 for a very well hidden item (secret passage activated by a button, document written in invisible ink). This action takes from one complete action (examining a desk) to one day (searching a library).</p>",
  },
  {
    name: "Melee",
    attribute: "STR",
    ...
    loadPenalty: !1,
    description:
      "<p>You use Melee to make melee attacks. DC is the target's Defense. If you hit, you deal damage according to the weapon used.</p>",
  },
  {
    name: "Medicine",
    attribute: "INT",
