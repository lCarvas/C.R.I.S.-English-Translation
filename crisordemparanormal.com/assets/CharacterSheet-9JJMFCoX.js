...
import {
  ...
  u as Jt,
  a as Yt,
} from "./index.esm2017-ZmoTU-BS.js";
import { T as Zt } from "./ToastNotification-E6g073Ap.js";
import {
  n as ca,
  I as He,
  g as er,
  ...
  G as Rr,
  H as wr,
} from "./ToastAttack-i3gHT8Nu.js";
import { _ as Uo } from "./d20-icon-vaz1En3o.js";
import { T as ve } from "./TabNav-GB7V06r-.js";
import { P as Xe } from "./PowerCard--892reTT.js";
import { R as Lo } from "./RitualCard-mXSyskD5.js";
import {
  W as Ho,
  P as xo,
  M as jo,
  C as Fo,
} from "./CursedItemCard-BYGkUIU8.js";
import {
  S as va,
  H as Ir,
  b as Mr,
  ...
  M as ma,
  c as Xo,
} from "./HomebrewItems-A12xqQbf.js";
import { c as $e } from "./attributes-I0efBVjK.js";
import { S as ye } from "./SearchInput-n9LbYIZb.js";
import { b as Tr, c as Vr } from "./ClassCard-TbhOrYLI.js";
import { c as zr, d as _r } from "./marcasFragmentadas-ZyBgiAnp.js";
import { a as Or, b as Ur, c as Lr } from "./parceitosData-pYeB3vP6.js";
import { S as ha } from "./SourcesNavigation-okweyYJS.js";
...
import { _ as Fe, l as Ro } from "./lodash-gzw5KmHd.js";
import { D as Se } from "./DropdownSimple-gEKaWzqJ.js";
import { P as fa } from "./PictureModal-tmAlMhGN.js";
import { v as Ne } from "./v4-cyCr5FZV.js";
import { S as Te } from "./SwitchButtonBool-W8E6bK9H.js";
import { _ as Ve } from "./blank-profile-picture-wMh28flS.js";
import { L as Xr } from "./LoadingView-H3Q1po81.js";
import {
  s as Jo,
  r as Wr,
  e as Kr,
  o as Jr,
  c as Yr,
} from "./characterAutomations-3K9JWEvl.js";
import { u as Zr, d as es } from "./dice-roll--q1la88v.js";
import { g as as, C as os } from "./firebase-lVLc_m94.js";
import "./edit-icon-3vZQUsyW.js";
import "./show-more-icon-VvUXKiHG.js";
import "./add-icon-fJ4uQHUZ.js";
import "./CardSource-VJPSYPUu.js";
import "./_commonjsHelpers-4gQjN7DL.js";
import "./browser-image-compression-9kymdGFS.js";
const ts = "/assets/sobrevivendo-ao-horror-off-7JypCJnD.webp",
  rs = "/assets/sobrevivendo-ao-horror-on-553JUvpA.webp",
  ss = "/assets/shield-icon-FCvc8PM4.png",
  ns = { class: "sheet-subtitle" },
  is = { class: "dropdown-button-container" },
  ds = ["onClick"],
  ls = T({
  ...
  pa = V(ls, [["__scopeId", "data-v-c7dc5afd"]]),
  ...
  gs = [ps],
  vs = { class: "info-row1" },
  hs = { class: "nex-container" },
  fs = { key: 1, class: "mundano-nex-container" },
  bs = { class: "sheet-subtitle" },
  qs = { key: 2, class: "pe-container" },
  Cs = { class: "pe" },
  As = ["disabled", "value"],
  ys = J(() => e("h4", { class: "alt-nex" }, " LPE ", -1)),
  Ps = { class: "pe-container" },
  Es = { class: "pe" },
  Ss = ["disabled", "value"],
  ks = { class: "desl-container" },
  Rs = { class: "desl-input-container" },
  ws = ["disabled", "value"],
  Is = J(() => e("h4", null, "m /", -1)),
  Ms = ["disabled", "value"],
  $s = J(() => e("h4", null, "q", -1)),
  Ds = J(() => e("h3", null, "SPEED", -1)),
  Ts = { class: "info-bar-wrapper" },
  Vs = { class: "info-row" },
  zs = { class: "defense-container" },
  _s = { class: "defense-img-container" },
  Os = J(() =>
    e("img", { class: "defense-img", src: ss, alt: "defense" }, null, -1)
  ),
  Us = { class: "defense-value" },
  Ls = { class: "defense-content" },
  Hs = J(() =>
    e(
      "div",
      { class: "defense-text" },
  ...
  xs = { class: "defense-input" },
  js = ["disabled", "value"],
  Fs = J(() => e("h5", null, "Equip.", -1)),
  Ns = J(() => e("h4", { class: "defense-plus" }, " + ", -1)),
  Bs = { class: "defense-input" },
  Qs = ["disabled", "value"],
  Gs = J(() => e("h5", null, "Other", -1)),
  Xs = { class: "other-defenses-container" },
  Ws = { class: "other-defense-div" },
  Ks = J(() => e("div", { class: "other-defense-label" }, " BLOCK DR ", -1)),
  Js = ["disabled", "value"],
  Ys = { class: "other-defense-div" },
  Zs = J(() => e("div", { class: "other-defense-label" }, " DODGE ", -1)),
  en = ["disabled", "value"],
  an = { class: "info-line" },
  on = J(() => e("h3", null, "ARMOR", -1)),
  tn = ["disabled", "value"],
  rn = { class: "info-line" },
  sn = J(() => e("h3", null, "RESISTANCES", -1)),
  nn = ["disabled", "value"],
  dn = { class: "info-line" },
  ln = J(() => e("h3", null, "PROFICIENCIES", -1)),
  un = ["disabled", "value"],
  cn = T({
    __name: "InfoView",
    ...
    setup(o, { emit: q }) {
      ...
      return (r, i) => (
        ...
        s("div", us, [
          ...
          e("div", Vs, [
            e("div", zs, [
              e("div", _s, [Os, e("div", Us, [e("h3", null, U(l.value), 1)])]),
              e("div", Ls, [
                Hs,
                e("div", xs, [
                  e(
  ...
  mn = V(cn, [["__scopeId", "data-v-80dedc69"]]),
  pn = { class: "sheet-stats-container" },
  gn = T({
    __name: "SheetStats",
    props: { character: {}, disabledSheet: { type: Boolean } },
    emits: [
          ...
          A(
            ar,
            {
              ...
              onHandleChangeAttribute:
                g[0] || (g[0] = (l) => m.$emit("handleChangeAttribute", l)),
          ...
          A(
            mn,
            {
              ...
              onHandleChangeSobrevivendoAoHorror:
                g[1] ||
                (g[1] = (l) => m.$emit("handleChangeSobrevivendoAoHorror")),
              onHandleChangeCharText:
                g[2] || (g[2] = (l) => m.$emit("handleChangeCharText", l)),
              onHandleChangeCharNumber:
                g[3] || (g[3] = (l) => m.$emit("handleChangeCharNumber", l)),
              onHandleChangeCharDropdown:
                g[4] || (g[4] = (l) => m.$emit("handleChangeCharDropdown", l)),
              onHandleChangeMovementInSquares:
                g[5] ||
                (g[5] = (l) => m.$emit("handleChangeMovementInSquares", l)),
              onHandleChangeCharNumberButton:
                g[6] ||
                (g[6] = (l, c) =>
                  m.$emit("handleChangeCharNumberButton", l, c)),
              onHandleChangeCharMark:
                g[7] ||
                (g[7] = (l, c) => m.$emit("handleChangeCharMark", l, c)),
              onHandleChangeMarkModeToTrue:
                g[8] ||
                (g[8] = (l) => m.$emit("handleChangeMarkModeToTrue", l)),
              onHandleMarkHeal:
                g[9] || (g[9] = (l) => m.$emit("handleMarkHeal", l)),
              onHandleOpenModalAddClass:
                g[10] || (g[10] = (l) => m.$emit("handleOpenModalAddClass")),
            },
            null,
            8,
            ["character", "disabled-sheet"]
  ...
  wo = V(gn, [["__scopeId", "data-v-4b3943e4"]]),
  vn = { class: "dropdown-button-container" },
  hn = { key: 0, class: "span" },
  fn = ["disabled"],
  bn = { key: 1, class: "span" },
  qn = ["onClick"],
  ...
  xe = V(Cn, [["__scopeId", "data-v-7777a8ec"]]),
  ba = (o) => (L("data-v-05af1f88"), (o = o()), H(), o),
  An = { class: "small" },
  yn = ba(() => e("img", { src: Uo, alt: "rolar" }, null, -1)),
  Pn = [yn],
  En = { key: 0 },
  Sn = { key: 1 },
  kn = { key: 0 },
  Rn = { key: 1 },
  wn = { class: "skill-bonus" },
  In = ba(() => e("span", null, "( ", -1)),
  Mn = ba(() => e("span", null, " )", -1)),
  $n = { key: 2 },
  Dn = { key: 3 },
  ...
  zn = T({
    ...
    setup(o, { emit: q }) {
      ...
      const u = o,
        ...
        c = Qe(),
        d = B(() =>
          u.skill.trainingDegree === "5"
            ? l.trained
            : u.skill.trainingDegree === "10"
              ? l.veteran
              : u.skill.trainingDegree === "15"
                ? l.expert
                : "#fff"
        ),
        r = () => {
          v("handleOpenSkillModal", u.skill);
        },
        i = (f, S, P) => {
      ...
      return (f, S) => (
        ...
        s(
          ...
          [
            ...
            e(
              ...
              [
                e(
                  ...
                  [
                    ne(U(o.skill.name), 1),
                    o.skill.onlyTrained ? (t(), s("span", En, "*")) : C("", !0),
                    o.skill.loadPenalty ? (t(), s("span", Sn, "+")) : C("", !0),
                  ],
                  2
                ),
              ],
            ...
            e("td", null, [e("h3", wn, [In, ne(U(o.skill.bonus), 1), Mn])]),
            o.index > o.length - 7
              ? (t(),
                s("td", $n, [
                  A(
  ...
  _n = V(zn, [["__scopeId", "data-v-05af1f88"]]),
  qa = (o) => (L("data-v-f2b17d30"), (o = o()), H(), o),
  On = { class: "skills-container" },
  Un = qa(() => e("h1", { class: "skills-title" }, " SKILLS ", -1)),
  Ln = { class: "skills-table" },
  Hn = qa(() =>
    e(
      "thead",
      null,
  ...
  jn = T({
    ...
    setup(o, { emit: q }) {
      const u = o,
        v = q,
        m = (l) => {
          u.disabledSheet || v("handleOpenSkillModal", l);
        },
        g = (l) => {
          u.disabledSheet || v("handleRollSkill", l);
        };
      return (l, c) => (
        t(),
        s("div", On, [
                      ...
                      A(
                        _n,
                        {
                          ...
                          onHandleChangeSkillDropdown:
                            c[0] ||
                            (c[0] = (i) =>
                              l.$emit("handleChangeSkillDropdown", i)),
                          onHandleChangeSkillOtherBonus:
                            c[1] ||
                            (c[1] = (i) =>
                              l.$emit("handleChangeSkillOtherBonus", i)),
                          onHandleRollSkill: g,
                        },
                        null,
                        8,
  ...
  Io = V(jn, [["__scopeId", "data-v-f2b17d30"]]),
  Ca = (o) => (L("data-v-f08c1d1d"), (o = o()), H(), o),
  Fn = { class: "tab" },
  Nn = { key: 0 },
  Bn = { class: "roll-dices-container" },
  Qn = ["disabled", "onKeyup"],
  Gn = ["disabled"],
  Xn = Ca(() =>
  ...
  Kn = { key: 2 },
  Jn = { key: 0 },
  Yn = { key: 1, class: "no-content" },
  Zn = Ca(() => e("h3", null, "No attack found", -1)),
  ei = [Zn],
  ai = { key: 3, class: "no-content" },
  oi = Ca(() => e("h3", null, "You don't have any attacks", -1)),
  ti = [oi],
  ri = T({
    __name: "AttacksTab",
    props: { character: {}, disabledSheet: { type: Boolean } },
    ...
    setup(o, { emit: q }) {
      const u = o,
        ...
        g = E(""),
        l = () => {
          u.disabledSheet || (v("handleRollDices", m.value), (m.value = ""));
        },
        c = (r) => {
          u.disabledSheet || v("handleRollAttack", r);
        },
        d = B(() => [...u.character.attacks].filter((i) => K(i.name, g.value)));
      return (r, i) => (
        t(),
        s("div", Fn, [
  ...
  Yo = V(ri, [["__scopeId", "data-v-f08c1d1d"]]),
  Zo = (o) => (L("data-v-79ae51ca"), (o = o()), H(), o),
  si = { class: "tab" },
  ni = { class: "tab-header" },
  ii = { key: 0 },
  di = { key: 1, class: "sheet-cards-container" },
  li = { key: 0 },
  ui = { key: 1, class: "no-content" },
  ci = Zo(() => e("h3", null, "No abilities found", -1)),
  mi = [ci],
  pi = { key: 2, class: "no-content" },
  gi = Zo(() => e("h3", null, "You don't have any abilities", -1)),
  vi = [gi],
  hi = T({
    __name: "AbilitiesTab",
    props: { character: {}, disabledSheet: { type: Boolean } },
  ...
  et = V(hi, [["__scopeId", "data-v-79ae51ca"]]),
  Aa = (o) => (L("data-v-d3cb0405"), (o = o()), H(), o),
  fi = { class: "tab" },
  bi = { class: "tab-header" },
  qi = { key: 0 },
  Ci = { class: "ritual-dc-wrapper" },
  Ai = { class: "ritual-dc-container" },
  yi = Aa(() => e("h4", { class: "sheet-subtitle" }, " RITUAL DC ", -1)),
  Pi = ["disabled", "value"],
  Ei = { key: 1, class: "sheet-cards-container" },
  Si = { key: 0 },
  ki = { key: 1, class: "no-content" },
  Ri = Aa(() => e("h3", null, "No rituals found", -1)),
  wi = [Ri],
  Ii = { key: 2, class: "no-content" },
  Mi = Aa(() => e("h3", null, "You don't have any rituals", -1)),
  $i = [Mi],
  Di = T({
    __name: "RitualsTab",
    props: { character: {}, disabledSheet: { type: Boolean } },
  ...
  at = V(Di, [["__scopeId", "data-v-d3cb0405"]]),
  ce = (o) => (L("data-v-d9d5c266"), (o = o()), H(), o),
  Ti = { class: "tab" },
  Vi = { class: "tab-header" },
  zi = { key: 0 },
  _i = { class: "inventory-info-container" },
  Oi = { class: "inventory-row" },
  Ui = { class: "input-container" },
  Li = ce(() => e("h4", { class: "sheet-subtitle" }, " PRESTIGE POINTS ", -1)),
  Hi = ["disabled", "value"],
  xi = { class: "inventory-row" },
  ji = { key: 0 },
  Fi = { class: "input-container" },
  Ni = ce(() => e("h4", { class: "sheet-subtitle" }, " ITEM LIMIT ", -1)),
  Bi = ["disabled", "value"],
  Qi = ["disabled", "value"],
  Gi = ["disabled", "value"],
  Xi = ["disabled", "value"],
  Wi = { key: 1 },
  Ki = { class: "input-container" },
  Ji = ce(() => e("h4", { class: "sheet-subtitle" }, " ITEM LIMIT ", -1)),
  Yi = { class: "mobile-input-container-row" },
  Zi = ["disabled", "value"],
  ed = ["disabled", "value"],
  ad = ["disabled", "value"],
  od = ["disabled", "value"],
  td = { class: "inventory-row" },
  rd = { key: 0 },
  ...
  gd = { class: "mobile-input-container-row" },
  vd = { class: "sheet-div" },
  hd = { class: "sheet-div" },
  fd = { class: "sheet-div" },
  bd = { class: "sheet-div" },
  ...
  yd = ce(() => e("h4", { class: "sheet-subtitle" }, " MAX LOAD ", -1)),
  Pd = ["disabled", "value"],
  Ed = ["disabled", "value"],
  Sd = { key: 1 },
  kd = ce(() =>
  ...
  Rd = { class: "mobile-input-container-row" },
  wd = ["disabled", "value"],
  Id = ["disabled", "value"],
  Md = { class: "open-add-buttons-container" },
  $d = { key: 0, class: "open-add-title" },
  Dd = { key: 0, class: "sheet-cards-container" },
  Td = { key: 0 },
  Vd = { key: 0 },
  zd = { key: 1 },
  _d = { key: 2 },
  ...
  Ld = ce(() => e("h3", null, "No item found", -1)),
  Hd = [Ld],
  xd = { key: 1, class: "no-content" },
  jd = ce(() => e("h3", null, "You do not have any items", -1)),
  Fd = [jd],
  Nd = T({
    __name: "InventoryTab",
    props: { character: {}, disabledSheet: { type: Boolean } },
    ...
    setup(o, { emit: q }) {
      ...
      const u = o,
        ...
        i = B(() =>
          u.character.currentLoad > u.character.maxLoad * 2
            ? "#d9534f"
            : u.character.currentLoad > u.character.maxLoad
              ? "#ff8c00"
              : "#fff"
        ),
        p = B(() =>
          u.character.currentLoad < 0 ? 0 : u.character.currentLoad
        ),
        ...
        S = (b, y) => {
          ...
          (v("handleChangeItemsLimit", { value: $, key: y }),
            (X = l == null ? void 0 : l.proxy) == null || X.$forceUpdate());
        },
        P = (b, y) => {
          var X;
          const $ = b.target.valueAsNumber;
        ...
        (b, y) => {
          ...
          return (
            ...
            s("div", Ti, [
              ...
              e("div", Md, [
                b.disabledSheet ? C("", !0) : (t(), s("div", $d, " NEW ")),
                b.disabledSheet
                  ? C("", !0)
                  : (t(),
                    s(
  ...
  ot = V(Nd, [["__scopeId", "data-v-d9d5c266"]]),
  Bd = { class: "tab" },
  Qd = { class: "textarea-container" },
  Gd = ["disabled", "placeholder", "value", "onBlur"],
  Xd = T({
    ...
    setup(o, { emit: q }) {
      const u = q,
        v = (g, l) => {
          const c = { value: g.target.value, key: l };
          u("handleChangeDescription", c);
        },
        m = [
          {
            title: "Notes",
  ...
  tt = V(Xd, [["__scopeId", "data-v-c2fd2df6"]]),
  Wd = { class: "sheet-tab-container" },
  Kd = { class: "tab-nav-container" },
  Jd = T({
    __name: "SheetTabView",
    props: { character: {}, disabledSheet: { type: Boolean } },
    emits: [
    ...
    setup(o, { emit: q }) {
      const u = q,
        ...
        g = E(0),
        l = (R) => (g.value = R),
        c = (R) => u("handleChangeAttackText", R),
        d = (R) => u("handleChangeAttackNumber", R),
        r = (R) => u("handleChangeAttackDropdown", R),
        i = (R) => u("handleChangeDescription", R),
        p = (R) => u("handleChangeInventoryNumber", R),
        f = (R) => u("handleChangeItemsLimit", R),
        S = (R) => u("handleChangeInventoryDropdown", R),
        P = (R) => u("handleRollAttack", R),
        b = (R) => u("handleChangeRitualDc", R),
        y = (R) => u("handleEditPower", R),
        $ = (R) => u("handleEditRitual", R),
        X = (R) => u("handleEditAttack", R),
        ie = (R) => u("handleEditItem", R),
        a = (R, k) => u("handleRollRitual", R, k);
      return (R, k) => (
        t(),
        s("div", Wd, [
          e("div", Kd, [
  ...
  Yd = V(Jd, [["__scopeId", "data-v-ff57a115"]]),
  Zd = { class: "class-abilities-container" },
  el = { key: 0, class: "search-container" },
  al = { key: 1, class: "class-abilities-content" },
  ol = T({
    ...
    setup(o, { emit: q }) {
      ...
      ue(() => {
        (l.value.push({ label: `${u.classValue.name} Powers`, value: 0 }),
          u.classValue.paths.forEach((p, f) => {
            (l.value.push({ label: p.name, value: f + 1 }), g.value.push(p));
          }));
        for (const p of u.classValue.abilities) m.value.push(p);
        for (const p of u.classValue.powers) m.value.push(p);
      });
      const i = B(() =>
        m.value
          ? c.value === 0
                  ...
                  N(
                    ...
                    (S) => (
                      ...
                      s("div", { key: S.name, class: "class-abilitie-card" }, [
                        A(Xe, { power: S, onHandleAdd: r }, null, 8, ["power"]),
                      ])
                    )
                  ),
                  128
  ...
  ua = V(ol, [["__scopeId", "data-v-bb507b22"]]),
  tl = { class: "class-abilities-container" },
  rl = { class: "search-container" },
  sl = { class: "class-abilities-content" },
  nl = T({
    __name: "BackgroundPower",
    emits: ["handleAddPower"],
    setup(o, { emit: q }) {
      const u = q,
        v = (c) => u("handleAddPower", c),
        m = E([]),
        g = E("");
      ue(() => {
              ...
              N(
                ...
                (r) => (
                  ...
                  s("div", { key: r.name, class: "class-abilitie-card" }, [
                    A(Xe, { power: r, onHandleAdd: v }, null, 8, ["power"]),
                  ])
                )
              ),
              128
  ...
  il = V(nl, [["__scopeId", "data-v-5db4501a"]]),
  dl = [
    {
  ...
  ml = { class: "class-abilities-container" },
  pl = { key: 1, class: "class-abilities-content" },
  gl = T({
    ...
    setup(o, { emit: q }) {
      ...
      const c = (r) => v("handleAddPower", r),
        d = B(() =>
          u.currentSource === "arquivosConfidenciais"
            ? cl
            : u.currentSource === "marcasFragmentadas"
              ? zr
              : u.currentSource === "grimorioParanormal"
                ? l.value
                : dl.filter((r) => r.element === m[g.value].label)
        );
      return (r, i) => (
        t(),
        s("div", ml, [
                  ...
                  N(
                    ...
                    (p) => (
                      ...
                      s("div", { key: p.name, class: "class-abilitie-card" }, [
                        A(Xe, { power: p, onHandleAdd: c }, null, 8, ["power"]),
                      ])
                    )
                  ),
                  128
  ...
  Mo = V(gl, [["__scopeId", "data-v-49dcdce3"]]),
  vl = { class: "abilities-modal-content" },
  hl = { key: 1 },
  fl = { key: 2 },
  bl = { key: 3 },
  ql = { key: 4 },
      ...
      return (c, d) => (
        ...
        s("div", vl, [
          ...
          c.currentSource === "ordemParanormal" && m.value === 0
            ? (t(),
              s("div", hl, [
                A(
                  ua,
                  { "class-value": F($e)[0], onHandleAddPower: l },
                  null,
                  8,
                  ["class-value"]
                ),
          ...
          c.currentSource === "ordemParanormal" && m.value === 1
            ? (t(),
              s("div", fl, [
                A(
                  ua,
                  { "class-value": F($e)[1], onHandleAddPower: l },
                  null,
                  8,
                  ["class-value"]
                ),
          ...
          c.currentSource === "ordemParanormal" && m.value === 2
            ? (t(),
              s("div", bl, [
                A(
                  ua,
                  { "class-value": F($e)[2], onHandleAddPower: l },
                  null,
                  8,
                  ["class-value"]
                ),
          ...
          c.currentSource === "ordemParanormal" && m.value === 3
            ? (t(), s("div", ql, [A(il, { onHandleAddPower: l })]))
            : C("", !0),
          c.currentSource === "ordemParanormal" && m.value === 4
            ? (t(),
              s("div", Cl, [
                A(
                  Mo,
                  { "current-source": c.currentSource, onHandleAddPower: l },
                  null,
                  8,
                  ["current-source"]
                ),
  ...
  Pl = V(yl, [["__scopeId", "data-v-bbaf9fc1"]]),
  rt = (o) => (L("data-v-3494da5b"), (o = o()), H(), o),
  El = { class: "modal-content modal-width" },
  Sl = { class: "modal-header" },
  kl = rt(() => e("h2", null, "Add Abilities", -1)),
  Rl = rt(() =>
  ...
  $l = V(Ml, [["__scopeId", "data-v-3494da5b"]]),
  W = [
    {
      name: "Short Bullets",
      category: "0",
  ...
  Ll = { class: "class-abilities-container" },
  Hl = { key: 1, class: "search-container" },
  xl = { key: 2, class: "search-container" },
  jl = { key: 3, class: "search-container" },
  Fl = { key: 4, class: "search-container" },
  Nl = { key: 5, class: "class-abilities-content" },
  Bl = { key: 0 },
  Ql = { key: 1 },
  Gl = { key: 2 },
  Xl = { key: 3 },
  Wl = T({
    ...
    setup(o, { emit: q }) {
      ...
      const f = (P) => v("handleAddItem", P),
        S = B(() =>
          u.currentSource === "ordemParanormal" && g.value === 0
            ? Dl.filter((P) => K(P.name, l.value)).sort((P, b) =>
                P.name.localeCompare(b.name)
              )
            : u.currentSource === "ordemParanormal" && g.value === 1
              ? W.sort((P, b) => P.name.localeCompare(b.name))
              : u.currentSource === "ordemParanormal" && g.value === 2
                ? Tl.sort((P, b) => P.name.localeCompare(b.name))
                : u.currentSource === "ordemParanormal" && g.value === 3
                  ? Vl.filter((P) => K(P.name, c.value)).sort((P, b) =>
                      P.name.localeCompare(b.name)
                    )
                  : u.currentSource === "ordemParanormal" && g.value === 4
                    ? zl
                        .filter((P) => K(P.name, d.value))
                        .sort((P, b) => P.name.localeCompare(b.name))
                    : u.currentSource === "tocaDosMonstros"
                      ? _l.sort((P, b) => P.name.localeCompare(b.name))
                      : u.currentSource === "cultoDaCriacao"
                        ? Hr.sort((P, b) => P.name.localeCompare(b.name))
                        : u.currentSource === "arquivosConfidenciais"
                          ? ul.sort((P, b) => P.name.localeCompare(b.name))
                          : u.currentSource === "grimorioParanormal"
                            ? p.value
                            : u.currentSource === "comunidade"
                              ? i.value
  ...
  Kl = V(Wl, [["__scopeId", "data-v-b68bb4af"]]),
  st = (o) => (L("data-v-f632863c"), (o = o()), H(), o),
  Jl = { class: "modal-content modal-width" },
  Yl = { class: "modal-header" },
  Zl = st(() => e("h2", null, "Add Items", -1)),
  eu = st(() =>
    e("img", { class: "close-icon", src: oe, alt: "fechar" }, null, -1)
  ),
  au = [eu],
  ou = { class: "modal-body modal-height" },
  tu = T({
          ...
          e("div", ou, [
            ...
            g.value === "ordemParanormal"
              ? (t(),
                z(
                  va,
                  { key: 0, value: m.value, options: v, onHandleNavigation: l },
                  null,
                  8,
                  ["value"]
                ))
  ...
  ru = V(tu, [["__scopeId", "data-v-f632863c"]]),
  Me = [
    {
  ...
  su = { class: "rituals-modal-content" },
  nu = { class: "class-rituals-container" },
  iu = { class: "secondary-tab-container" },
  du = { key: 1, class: "search-container" },
  lu = { key: 2, class: "class-rituals-content" },
  uu = T({
      ...
      const i = (f) => v("handleAddRitual", f),
        p = B(() =>
          u.currentSource === "cultoDaCriacao"
            ...
            : u.currentSource === "arquivosConfidenciais"
              ? ll.sort((f, S) => f.name.localeCompare(S.name))
              : u.currentSource === "marcasFragmentadas"
                ...
                : u.currentSource === "grimorioParanormal"
                  ...
                  : l.value === 0
                    ? c.value === 0
                      ? Me.filter((f) => K(f.name, d.value)).sort((f, S) =>
                          f.name.localeCompare(S.name)
                        )
                      : Me.filter((f) => f.circle === g[c.value].circle)
                    ...
                    : c.value === 0
                      ? l.value === 0
                        ...
                        : Me.filter((f) => f.element === m[l.value].label)
                            .filter((f) => K(f.name, d.value))
                            .sort((f, S) => f.name.localeCompare(S.name))
                      : Me.filter((f) => f.element === m[l.value].label)
                          .filter((f) => K(f.name, d.value))
              ...
              ? (t(),
                z(
                  ve,
                  {
                    ...
                    "current-tab": l.value,
                    "tab-options": m,
                    onHandleNavigation: S[0] || (S[0] = (P) => (l.value = P)),
                  },
                  null,
                  8,
                  ["current-tab"]
  ...
  cu = V(uu, [["__scopeId", "data-v-f0c93785"]]),
  nt = (o) => (L("data-v-bd59e041"), (o = o()), H(), o),
  mu = { class: "modal-content modal-width" },
  pu = { class: "modal-header" },
  gu = nt(() => e("h2", null, "Add Rituals", -1)),
  vu = nt(() =>
    e("img", { class: "close-icon", src: oe, alt: "fechar" }, null, -1)
  ),
  hu = [vu],
  fu = { class: "modal-body modal-height" },
  bu = T({
    __name: "RitualsModal",
    props: { character: {} },
    emits: ["handleAddRitual", "handleCloseModal"],
  ...
  qu = V(bu, [["__scopeId", "data-v-bd59e041"]]),
  Cu = (o) => (L("data-v-25deaea6"), (o = o()), H(), o),
  Au = { class: "modal-content modal-width" },
  yu = { class: "modal-header" },
  Pu = Cu(() =>
    e("img", { class: "close-icon", src: oe, alt: "fechar" }, null, -1)
  ),
  Eu = [Pu],
      ...
      return (q, u) => (
        ...
        s("div", Au, [
          e("div", yu, [
            ...
            e(
              "button",
              { onClick: u[0] || (u[0] = (v) => q.$emit("handleCloseModal")) },
              Eu
            ),
          ]),
          e("div", Su, [
  ...
  wu = V(Ru, [["__scopeId", "data-v-25deaea6"]]),
  Y = (o) => (L("data-v-8f535d56"), (o = o()), H(), o),
  Iu = { class: "form-container" },
  Mu = { class: "input-container" },
  $u = Y(() => e("div", { class: "label" }, " Name* ", -1)),
  Du = { class: "input-row" },
  Tu = { class: "input-container" },
  Vu = Y(() => e("div", { class: "label" }, " Damage* ", -1)),
  zu = { class: "input-container" },
  _u = Y(() => e("div", { class: "label" }, " Critical* ", -1)),
  Ou = { class: "input-container" },
  Uu = Y(() => e("div", { class: "label" }, " Multiplier* ", -1)),
  Lu = { class: "input-row" },
  Hu = { class: "input-container" },
  xu = Y(() => e("div", { class: "label" }, " Attack Bonus ", -1)),
  ju = { class: "input-container" },
  Fu = Y(() => e("div", { class: "label" }, " Damage Type ", -1)),
  Nu = { class: "input-row" },
  Bu = { class: "input-container" },
  Qu = Y(() => e("div", { class: "label" }, " Range ", -1)),
  Gu = { class: "input-container" },
  Xu = Y(() => e("div", { class: "label" }, " Skill ", -1)),
  Wu = { class: "input-container" },
  Ku = Y(() => e("div", { class: "label" }, " Damage Attribute ", -1)),
  Ju = { class: "title-container" },
  Yu = Y(() => e("div", { class: "title" }, " Extra Damage: ", -1)),
  Zu = { key: 0, class: "extra-damage-container" },
  ec = { class: "input-row extra-damage-row" },
  ac = { class: "input-row" },
  oc = { class: "input-container" },
  tc = Y(() => e("div", { class: "label" }, " Damage* ", -1)),
  rc = ["onUpdate:modelValue"],
  sc = { class: "input-container" },
  nc = Y(() => e("div", { class: "label" }, " Type* ", -1)),
  ic = { class: "button-remove-container" },
  dc = ["onClick"],
  lc = { class: "row" },
  uc = Y(() => e("div", { class: "label" }, " Image ", -1)),
  cc = { key: 0 },
  mc = ["src"],
  pc = { key: 1 },
  gc = Y(() =>
  ...
  bc = { class: "buttons-container" },
  qc = ["disabled"],
  Cc = { key: 0 },
  Ac = T({
    __name: "AttackForm",
    props: { attack: { type: Object, default: De }, addMode: Boolean },
    ...
    setup(o, { emit: q }) {
      const u = o,
        ...
        p = () => {
          (Ro.isArray(d.value.aditionalDamage) ||
        ...
        S = () => {
          ((d.value = Fe.clone(De)), v("handleClose"));
        },
        P = () => {
          if (i.value) return;
          Gr(d.value);
          const y = { attack: d.value };
          (v("handleEditAttack", y), (d.value = Fe.clone(De)));
        },
        b = (y, $) => {
          i.value ||
  ...
  it = V(Ac, [["__scopeId", "data-v-8f535d56"]]),
  dt = (o) => (L("data-v-6ad99d7a"), (o = o()), H(), o),
  yc = { class: "modal-content modal-width" },
  Pc = { class: "modal-header" },
  Ec = dt(() => e("h2", null, "Edit", -1)),
  Sc = dt(() =>
    e("img", { class: "close-icon", src: oe, alt: "fechar" }, null, -1)
  ),
  kc = [Sc],
  Rc = { class: "modal-body modal-height" },
  wc = { key: 0 },
  Ic = { key: 1 },
  Mc = { key: 2 },
  $c = { key: 3 },
  ...
  _c = T({
    ...
    props: {
      ...
      editAttack: { type: Object, default: De },
    },
    emits: [
      "handleCloseModal",
    ...
    setup(o, { emit: q }) {
      const u = q,
        ...
        m = (d) => u("handleEditPowerSheet", d.power),
        g = (d) => u("handleEditRitualSheet", d.ritual),
        l = (d) => u("handleEditItemSheet", d.item),
        c = (d) => u("handleEditAttackSheet", d.attack);
      return (d, r) => (
        t(),
        s("div", yc, [
          e("div", Pc, [
  ...
  Oc = V(_c, [["__scopeId", "data-v-6ad99d7a"]]),
  We = (o) => (L("data-v-6cd98f8c"), (o = o()), H(), o),
  Uc = { key: 0, class: "row" },
  Lc = We(() =>
  ...
  Qc = T({
    ...
    setup(o, { emit: q }) {
      const u = q,
        ...
        g = (c) => {
          u("handleChangeStatsClass", c);
        },
        l = (c, d) => {
          u("handleChangeEditPermissions", c, d);
        };
      return (c, d) => (
        t(),
        s(
            ...
            e("div", Hc, [
              ...
              A(
                Te,
                {
                  ...
                  options: v,
                  onHandleChange: d[0] || (d[0] = (r) => l("private", r)),
                },
                null,
                8,
                ["value"]
            ...
            e("div", jc, [
              ...
              A(
                Te,
                {
                  ...
                  options: v,
                  onHandleChange: d[1] || (d[1] = (r) => l("canDMEdit", r)),
                },
                null,
                8,
                ["value"]
            ...
            e("div", Nc, [
              ...
              A(
                Te,
                {
                  ...
                  options: v,
                  onHandleChange: d[2] || (d[2] = (r) => l("canAnyoneEdit", r)),
                },
                null,
                8,
                ["value"]
  ...
  Gc = V(Qc, [["__scopeId", "data-v-6cd98f8c"]]),
  Xc =
  ...
  Zc = { class: "row" },
  em = re(() => e("div", { class: "label" }, " Color of dice results ", -1)),
  am = ["value"],
  om = { class: "row" },
  tm = re(() =>
  ...
  rm = ["value"],
  sm = { class: "row" },
  nm = re(() => e("div", { class: "label" }, " Injured agent picture ", -1)),
  im = { key: 0 },
  dm = ["src"],
  lm = { key: 1 },
  um = re(() =>
    e(
      "img",
      { class: "profile-picture", src: Ve, alt: "foto agente em branco" },
      null,
      -1
    )
  ),
  cm = [um],
  mm = { class: "row" },
  pm = re(() => e("div", { class: "label" }, " Dying agent picture ", -1)),
  gm = { key: 0 },
  vm = ["src"],
  hm = { key: 1 },
  fm = re(() =>
  ...
  bm = [fm],
  qm = { class: "row" },
  Cm = re(() => e("div", { class: "label" }, " Disturbed agent picture ", -1)),
  Am = { key: 0 },
  ym = ["src"],
  Pm = { key: 1 },
  Em = re(() =>
  ...
  Vm = T({
    ...
    setup(o, { emit: q }) {
      const u = o,
        ...
        d = () => {
          window.open(
            "https://crisordemparanormal.com/agente/stream/" + u.character.id
          );
        };
      return (r, i) => {
        const p = Be("vue-final-modal");
        return (
          t(),
          s(
            x,
  ...
  zm = V(Vm, [["__scopeId", "data-v-87004152"]]),
  lt = (o) => (L("data-v-78a9772d"), (o = o()), H(), o),
  _m = { class: "modal-content modal-width" },
  Om = { class: "modal-header" },
  Um = lt(() => e("h2", null, "Settings", -1)),
  Lm = lt(() =>
    e("img", { class: "close-icon", src: oe, alt: "fechar" }, null, -1)
  ),
  Hm = [Lm],
  xm = { class: "modal-body modal-height" },
  jm = { key: 0, class: "content-container" },
  Fm = { key: 1, class: "content-container" },
  Nm = T({
    __name: "ConfigModal",
    props: { character: { type: Object, required: !0 } },
    emits: [
    ...
    setup(o, { emit: q }) {
      const u = q,
        ...
        m = E(0),
        g = (d) => {
          u("handleChangeStatsClass", d);
        },
        l = (d, r, i) => {
          u("handleUpdateAlternativePicture", d, r, i);
        },
        c = (d, r) => {
          u("handleChangeEditPermissions", d, r);
        };
      return (d, r) => (
        t(),
        s("div", _m, [
  ...
  Bm = V(Nm, [["__scopeId", "data-v-78a9772d"]]),
  ut = (o) => (L("data-v-2b669bfc"), (o = o()), H(), o),
  Qm = { class: "modal-content modal-width" },
  Gm = { class: "modal-header" },
  Xm = ut(() => e("h2", null, "Choose new class", -1)),
  Wm = ut(() =>
    e("img", { class: "close-icon", src: oe, alt: "fechar" }, null, -1)
  ),
  Km = [Wm],
  Jm = { class: "modal-body modal-height" },
  Ym = { class: "content-container" },
  Zm = { class: "add-class-description" },
  ep = { class: "classes-container" },
  ap = { class: "classes-flex" },
  op = T({
      ...
      return (m, g) => (
        ...
        s("div", Qm, [
          e("div", Gm, [
            ...
            e(
              "button",
              { onClick: g[0] || (g[0] = (l) => m.$emit("handleCloseModal")) },
              Km
            ),
          ]),
          e("div", Jm, [
                    ...
                    N(
                      ...
                      (l) => (
                        ...
                        s("div", { key: l.name }, [
                          A(
                            Vr,
                            { "char-class": l, onHandleAddClass: v },
                            null,
                            8,
                            ["char-class"]
                          ),
  ...
  tp = V(op, [["__scopeId", "data-v-2b669bfc"]]),
  rp = (o) => (L("data-v-be964fd1"), (o = o()), H(), o),
  sp = { class: "modal-content modal-width" },
  np = { class: "modal-header" },
  ip = rp(() =>
    e("img", { class: "close-icon", src: oe, alt: "fechar" }, null, -1)
  ),
  dp = [ip],
  lp = { class: "modal-body modal-height" },
  up = { key: 0 },
  cp = { key: 1 },
  mp = { key: 2 },
  pp = { key: 3 },
  ...
  bp = T({
    ...
    setup(o, { emit: q }) {
      const u = q,
        ...
        g = (r) => u("handleAddAttack", r.attack),
        l = (r) => u("handleAddPower", r.power),
        c = (r) => u("handleAddRitual", r.ritual),
        d = (r) => u("handleAddItem", r.item);
      return (r, i) => (
        t(),
        s("div", sp, [
          e("div", np, [
  ...
  qp = V(bp, [["__scopeId", "data-v-be964fd1"]]),
  ya = (o) => (L("data-v-15adeee7"), (o = o()), H(), o),
  Cp = { class: "modal-content modal-width" },
  Ap = { class: "modal-header" },
  yp = ya(() => e("h2", null, "Share", -1)),
  Pp = ya(() =>
    e("img", { class: "close-icon", src: oe, alt: "fechar" }, null, -1)
  ),
  Ep = [Pp],
  ...
  kp = T({
    ...
    emits: ["handleCloseModal"],
    setup(o) {
      const u = "https://crisordemparanormal.com/agente/" + o.character.id;
      return (v, m) => (
        t(),
        s("div", Cp, [
          e("div", Ap, [
  ...
  Rp = V(kp, [["__scopeId", "data-v-15adeee7"]]),
  wp =
  ...
  ze = (o) => (L("data-v-60e2e1d5"), (o = o()), H(), o),
  Ip = { class: "sheet-tools-container" },
  Mp = { key: 0 },
  $p = { key: 0 },
  Dp = { key: 0, class: "added-info" },
  Tp = { key: 1 },
  Vp = ze(() => e("img", { src: wp, alt: "adicionar" }, null, -1)),
  zp = [Vp],
  _p = { key: 1, class: "sheet-tools-mobile-container" },
  Op = { key: 0, class: "sheet-tools-buttons-container" },
  Up = ze(() => e("img", { src: ct, alt: "compartilhar" }, null, -1)),
  Lp = [Up],
  Hp = ze(() => e("img", { src: mt, alt: "configurações" }, null, -1)),
  xp = [Hp],
  jp = { key: 1, class: "share-mobile-container" },
  Fp = ze(() => e("img", { src: ct, alt: "compartilhar" }, null, -1)),
  Np = [Fp],
  Bp = ze(() => e("img", { src: mt, alt: "configurações" }, null, -1)),
  Qp = [Bp],
  Gp = T({
    __name: "SheetTools",
                  ...
                  F(v).currentUser
                    ? (t(),
                      s("div", $p, [
                        o.charAdded
                          ? (t(),
                            s("div", Dp, " Agent saved to your collection! "))
                          : (t(),
                            s("div", Tp, [
                              e(
                                "button",
  ...
  $o = V(Gp, [["__scopeId", "data-v-60e2e1d5"]]),
  Ke = (o) => (L("data-v-552e0b49"), (o = o()), H(), o),
  Xp = { class: "sheet-header-container" },
  Wp = { class: "profile-picture-container" },
  Kp = ["disabled"],
  Jp = { key: 0 },
  Yp = ["src"],
  Zp = { key: 1 },
  eg = { class: "header-info-container" },
  ag = { class: "header-info-row" },
  og = { class: "info-line" },
  tg = Ke(() => e("h3", null, "CHARACTER", -1)),
  rg = ["disabled", "value"],
  sg = { class: "info-line" },
  ng = Ke(() => e("h3", null, "PLAYER", -1)),
  ig = ["disabled", "value"],
  dg = { class: "header-info-row" },
  lg = { class: "info-line" },
  ug = Ke(() => e("h3", null, "BACKGROUND", -1)),
  cg = ["disabled", "value"],
  mg = { class: "info-line" },
  pg = Ke(() => e("h3", null, "CLASS", -1)),
  gg = ["disabled", "value"],
  vg = T({
    __name: "SheetHeader",
    props: { character: {}, disabledSheet: { type: Boolean } },
          ...
          e("div", Wp, [
            e(
              "button",
              {
                ...
                onClick:
                  u[0] ||
                  (u[0] = (v) => q.$emit("handleOpenChangePictureModal")),
              },
              [
  ...
  Do = V(vg, [["__scopeId", "data-v-552e0b49"]]),
  pt =
  ...
  hg = { class: "campaign-log-container" },
  fg = gt(() => e("img", { src: pt, alt: "log" }, null, -1)),
  bg = [fg],
  qg = gt(() => e("div", { class: "campaign-label" }, " Campaign: ", -1)),
  Cg = { class: "campaign-title" },
  Ag = T({
        ...
        return (
          ...
          s("div", hg, [
              ...
              ? (t(),
                s(
                  "button",
                  {
                    ...
                    onClick:
                      c[0] || (c[0] = (r) => l.$emit("handleOpenCampaignLog")),
                  },
                  bg
                ))
              : C("", !0),
            e(
              ...
              [
                qg,
                e("div", Cg, U((d = l.campaign) == null ? void 0 : d.name), 1),
              ],
              2
            ),
          ])
  ...
  To = V(Ag, [["__scopeId", "data-v-92e1679a"]]),
  yg =
  ...
  Pg = vt(() =>
    e("img", { class: "apps-img", src: yg, alt: "fechar" }, null, -1)
  ),
  Eg = [Pg],
  Sg = vt(() =>
  ...
  Ig = T({
    ...
    setup(o) {
      Re((l) => ({ "6493c1e2": m.value, df9ceb3e: g.value }));
      const q = o,
        u = E(!1),
        v = [
          "INFORMATIONS",
              ...
              ? (t(),
                s(
                  "button",
                  {
                    ...
                    onClick: c[1] || (c[1] = (d) => (u.value = !u.value)),
                  },
                  kg
                ))
              : (t(),
                s(
                  "button",
                  {
                    key: 0,
                    class: "apps-button button-naked",
                    onClick: c[0] || (c[0] = (d) => (u.value = !u.value)),
                  },
                  Eg
                )),
            u.value
              ? (t(),
                s(
                  "div",
                  {
                    ...
                    onClick: c[2] || (c[2] = (d) => (u.value = !u.value)),
                  },
                  [
                    e("div", Rg, [
                      (t(),
                          ...
                          e("div", { key: r }, [
                            e(
                              "button",
                              {
                                ...
                                onClick: (i) => l.$emit("handleMobileNav", r),
                              },
                              U(d),
                              9,
                              wg
  ...
  Mg = V(Ig, [["__scopeId", "data-v-5b13c98a"]]),
  ht = (o) => (L("data-v-f968449f"), (o = o()), H(), o),
  $g = ht(() => e("img", { src: pt, alt: "log" }, null, -1)),
  Dg = [$g],
  Tg = ht(() => e("img", { src: oe, alt: "close-log" }, null, -1)),
  Vg = [Tg],
  zg = T({
          ...
          ? (t(),
            s(
              "button",
              {
                ...
                onClick:
                  u[1] || (u[1] = (v) => q.$emit("handleOpenCampaignLog")),
              },
              Vg
            ))
          : (t(),
            s(
              "button",
              {
                ...
                class: "campaign-log-button-mobile button-naked",
                onClick:
                  u[0] || (u[0] = (v) => q.$emit("handleOpenCampaignLog")),
              },
              Dg
            ));
    },
  }),
  _g = V(zg, [["__scopeId", "data-v-f968449f"]]),
  Og = { class: "skin-img-container" },
  Ug = ["src", "alt"],
  Lg = { class: "label" },
  Hg = T({
    __name: "SkinOption",
    ...
    setup(o) {
      ...
      return (v, m) => (
        ...
        s(
          "div",
          {
            class: ae(["skin-option-container", { "skin-selected": u.value }]),
          },
          [
            e("div", Og, [
              e(
  ...
  je = V(Hg, [["__scopeId", "data-v-2d26e789"]]),
  we = (o) => (L("data-v-3967102f"), (o = o()), H(), o),
  xg = { class: "modal-content modal-width" },
  jg = { class: "modal-header" },
  Fg = we(() => e("h2", null, "Dice Skins", -1)),
  Ng = we(() =>
    e("img", { class: "close-icon", src: oe, alt: "fechar" }, null, -1)
  ),
  Bg = [Ng],
  Qg = { class: "modal-body modal-height" },
  Gg = { class: "skins-container" },
  Xg = we(() => e("div", { class: "skins-title" }, " Colors ", -1)),
  Wg = { class: "skins-options" },
  Kg = { class: "skins-container" },
  Jg = we(() => e("div", { class: "skins-title" }, " Relics ", -1)),
  Yg = { class: "skins-options" },
  Zg = { class: "skins-container" },
  ev = we(() => e("div", { class: "skins-title" }, " Elements ", -1)),
  av = { class: "skins-options" },
  ov = { class: "skins-container" },
  tv = we(() => e("div", { class: "skins-title" }, " Pride ", -1)),
  ...
  nv = V(sv, [["__scopeId", "data-v-3967102f"]]),
  Je = (o) => (L("data-v-2266640b"), (o = o()), H(), o),
  iv = { class: "modal-content modal-width" },
  dv = { class: "modal-header" },
  lv = Je(() => e("h2", null, "Optional rules - Sobrevivendo ao Horror", -1)),
  uv = Je(() =>
    e("img", { class: "close-icon", src: oe, alt: "fechar" }, null, -1)
  ),
  cv = [uv],
  mv = { class: "modal-body modal-height" },
  pv = { class: "row" },
  gv = Je(() =>
    e(
      "div",
      ...
      return (u, v) => (
        ...
        s("div", iv, [
          e("div", dv, [
            ...
            e(
              "button",
              { onClick: v[0] || (v[0] = (m) => u.$emit("handleCloseModal")) },
              cv
            ),
          ]),
          e("div", mv, [
            e("div", pv, [
              ...
              A(
                Te,
                {
                  value: u.character.isNexLevelOn,
                  options: q,
                  onHandleChange:
                    v[1] ||
                    (v[1] = (m) =>
                      u.$emit("handleChangeBooleanValue", "isNexLevelOn", m)),
                },
                null,
                8,
                ["value"]
            ...
            e("div", vv, [
              ...
              A(
                Te,
                {
                  value: u.character.isPdOn,
                  options: q,
                  onHandleChange:
                    v[2] ||
                    (v[2] = (m) =>
                      u.$emit("handleChangeBooleanValue", "isPdOn", m)),
                },
                null,
                8,
                ["value"]
  ...
  bv = V(fv, [["__scopeId", "data-v-2266640b"]]),
  qv = { class: "autography-container" },
  Cv = { key: 0, class: "autography-content" },
  Av = { key: 1, class: "autography-content" },
  yv = "Ghh98jAHMr6AK3bGXmxC",
  Pv = "cEIZX1gy8MiqlOQSZQwu",
  Ev = T({
    __name: "SheetAutography",
    setup(o) {
      const u = Oo().params.id;
      return (v, m) => (
        t(),
        s("div", qv, [
          F(u) === yv
  ...
  Vo = V(Ev, [["__scopeId", "data-v-d8f2dc5c"]]),
  Sv = (o) => (L("data-v-a8da6011"), (o = o()), H(), o),
  kv = { key: 0 },
  Rv = { key: 0, class: "private-sheet" },
  wv = Sv(() => e("h1", null, "Private sheet", -1)),
  Iv = { key: 1 },
  Mv = { key: 0 },
  $v = { class: "sheet-wrapper" },
  Dv = { class: "sheet-header" },
  Tv = { class: "character-sheet" },
  Vv = { class: "sheet-stats" },
  zv = { class: "sheet-skills" },
  _v = { class: "sheet-tab" },
  Ov = { key: 1 },
  Uv = { key: 0, class: "mobile-container" },
  Lv = { key: 1, class: "mobile-container" },
  Hv = { key: 2, class: "mobile-container" },
  xv = { key: 3, class: "mobile-container" },
  jv = { key: 4, class: "mobile-container" },
  Fv = { key: 5, class: "mobile-container" },
  Nv = { key: 6, class: "mobile-container" },
  Bv = { key: 7, class: "mobile-container" },
  Qv = { key: 2 },
  Gv = { key: 1 },
  Xv = T({
    ...
    setup(o) {
      ...
      const { play: q } = Zr(es),
        u = [$l, ru, qu, wu, Oc, fa, Bm, Rp, tp, qp, nv, bv],
        v = {
          abilities: 0,
          inventory: 1,
          rituals: 2,
      ...
      (ue(async () => {
        ...
        const n = await ra(le(c, "characters", p));
        (n.data() || i.push({ name: "not-found" }),
          l.currentUser &&
            (R.value = await as((I = l.currentUser) == null ? void 0 : I.uid)),
          (a.value = n.data()),
        ...
        if (
          ...
          if (a.value.statsClass === "Mundane")
            ...
            const M = $e.find((ee) => ee.name === a.value.statsClass);
            if (!M) return;
        ...
        if (
          ...
          h && (await sa(le(c, "characters", a.value.id), a.value)),
          a.value.campaignDocId)
        ) {
          const M = await ra(le(c, "campaigns", a.value.campaignDocId));
          M.data() &&
            ((P.value = M.data()),
            (P.value.id = M.id),
            (Pe.value = na(
        ...
        Ye.value = na(le(c, "characters", p), (M) => {
          var O, ee, de, Ee;
          (M.data() || i.push({ name: "not-found" }),
            ...
            a.value.uid !==
              ((O = l == null ? void 0 : l.currentUser) == null
                ? void 0
                : O.uid) && (a.value.private ? (_.value = !0) : (_.value = !1)),
            a.value.campaignDocId &&
              P.value &&
              P.value.uid ===
                ((ee = l == null ? void 0 : l.currentUser) == null
                  ? void 0
                  : ee.uid) &&
              ((_.value = !1),
              a.value.canDMEdit ? (k.value = !1) : (k.value = !0)),
            a.value.uid ===
              ((de = l == null ? void 0 : l.currentUser) == null
                ? void 0
                : de.uid) && ((_.value = !1), (k.value = !1)),
            ((Ee = l == null ? void 0 : l.currentUser) != null && Ee.uid) ||
              (k.value = !0),
            f.value < 2 && f.value++);
        });
      }),
        Ft(() => {
          (Ye.value && Ye.value(), Pe.value && Pe.value());
        }),
        be(f, () => {
          a.value &&
            S.value !== !1 &&
          ...
          async () => {
            if (a.value && !S.value)
              if (a.value.campaignDocId === "")
                ...
                const n = await ra(le(c, "campaigns", a.value.campaignDocId));
                n.data() &&
                  ((P.value = n.data()),
                  (Pe.value = na(
                    le(c, "campaignLogs", P.value.campaignLogId),
      ...
      const D = () => {
          k.value || sa(le(c, "characters", a.value.id), a.value);
        },
        Ue = () => {
        ...
        Oa = (n) => {
          ((Ea.value = n), (G.value = v.skill), (Q.value = !0));
        },
        Ua = () => {
        ...
        Na = () => {
          ((G.value = v.sobrevivendoAoHorror), (Q.value = !0));
        },
        Ba = () => {
        ...
        qt = (n) => {
          ((n.id = Ne()), a.value.attacks.push(n), D(), te());
        },
        Xa = (n) => {
          (pr(a.value, n), D());
        },
        ...
        oa = (n = "1d20", h = "Resultado", I = !1) => {
          try {
            const M = h,
              O = qr(n || "1d20"),
              ee = da(O.output),
              de = la(O.output);
            ((fe.value.defaultColor = I),
              ea(fe.value, M, O.total, ee, de),
              q());
          } catch {
            Le(j.value);
          }
        ...
        ge = (n) => {
          ((G.value = v.addModal), (Pa.value = n), (Q.value = !0));
        },
        so = () => ge(g.attack),
        no = () => ge(g.power),
        io = () => ge(g.ritual),
        ...
        $t = (n) => {
          ...
          if (
            ...
            const M = Yr.find((O) => O.id === n.automationId);
            if (n.isAutomationOn) {
        ...
        Vt = (n) => {
          (wr(a.value, n),
            a.value.mundanoRemoveSkill && aa(a.value.mundanoRemoveSkill),
            D(),
            te());
        },
        te = () => (Q.value = !1),
        ...
        qo = async () => {
          var h, I;
          if (!((h = l.currentUser) != null && h.email) || he.value) return;
          if (R.value < 3) {
            const M = Po(c, "characters"),
              O = Nt(
                M,
                Bt("uid", "==", (I = l.currentUser) == null ? void 0 : I.uid)
              );
            if ((await Qt(O)).size >= os) {
              (me(),
                pe(),
          ...
          he.value = !0;
          const n = Fe.cloneDeep(a.value);
          if (
            ((n.uid = l.currentUser.uid),
            (n.timestamp = Gt()),
            (n.campaignDocId = ""),
            (n.id = ""),
            a.value.sheetPictureURL !== "")
          ) {
            const M = Eo(d, `images/${Ne()}`),
        ...
        Co = (n, h) => {
          ...
          ((a.value.lastDiceResult = I), (a.value.didDiceRoll = Ne()), D());
        },
        Ao = (n, h) => {
          ...
          (b.value.campaignLogMessages.push(I),
            ...
            sa(le(c, "campaignLogs", b.value.id), b.value));
        },
        ta = () => {
      ...
      const Ot = B(() => (Oe.vtt ? "102px" : "0"));
      return (n, h) => {
        const I = Be("vue-final-modal");
        return (
          t(),
          s("div", null, [
            S.value
              ? (t(), s("div", Gv, [A(Xr, { "page-loading": "" })]))
              : (t(),
                s("div", kv, [
                  _.value
                    ? (t(),
                            ...
                            default: Ae(() => [
                              j.value.alive
                                ? (t(),
                                  z(
                                    Zt,
                                    { key: 0, toast: j.value, onDismiss: Ue },
                                    null,
                                    8,
                                    ["toast"]
                                  ))
  ...
  Mh = V(Xv, [["__scopeId", "data-v-a8da6011"]]);
export { Mh as default };
