const e = [
      ...
      powers: [
        {
          ...
          name: "Transformação",
          description:
            "<p>O enpap-X começa o combate como um existido comum. Quando ele é reduzido a 0 PV, porém, em vez de morrer, se TransformableImage, gerando o efeito de sua presença perturbadora. E recupera todos os seus PV, ficando com 360 PV.</p>",
        },
      ],
      actions: [
        {
      ...
      powers: [
        {
          ...
          name: "Julgamento",
          description:
            "<p>O anjo é uma criatura que se manifesta como fisicalização do Conhecimento e, portanto, é uma criatura que julga o saber. Sempre que um ser sofre dano de Conhecimento das asas do Conhecimento ou dos olhares do saber do Anjo, sofre também uma quantidade de dano mental igual à metade do dano de Conhecimento sofrido (após aplicar resistências). Um ser reduzido a Sanidade 0 desta formatem sua mente colapsadapelo julgamento do Anjoe inexiste, morrendoinstantaneamente.</p>",
        },
      ],
      actions: [
        {
          ...
          attacks: [
            {
              ...
              damage: [
                ...
                { id: "1", damageType: "energia", value: "2" },
              ],
              criticalMult: 2,
              criticalRange: 20,
            },
  ...
  d = [...e, ...a, ...o, ...r, ...s, ...i];
export { d as A, e as B, a as D, r as E, s as F, o as K, i as R };
