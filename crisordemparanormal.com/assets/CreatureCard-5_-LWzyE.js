...
import { c as a } from "./creatureData-R8saWVyd.js";
const P =
  ...
  re = x({
    ...
    setup(r, { emit: v }) {
      ...
      const e = r,
        ...
        h = b(null);
      D(h, (c) => {
        (c.target && c.target.id === "img.settings-button") || (n.value = !1);
      });
      const C = () => {
                ...
                t("div", Y, [
                  ...
                  r.canRemove
                    ? (o(),
                      s(
                        "button",
                        { key: 2, class: "primary-card-button", onClick: _ },
                        " Remove "
                      ))
                    : i("", !0),
                ]),
  ...
  le = T(re, [["__scopeId", "data-v-ae2ad5f4"]]);
export { le as C };
